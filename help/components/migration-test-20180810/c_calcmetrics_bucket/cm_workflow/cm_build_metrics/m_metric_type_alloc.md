...
uuid: e93a76fb-08d2-4bd0-8adc-481cf3918a4d
index: y
internal: n
snippet: y
translate: y
...
* [ Metric Type ](m_metric_type_alloc.md#section_34A86FB402F94E988724232283BF18B7)
* [ Allocation ](m_metric_type_alloc.md#section_F9690FD1943B403AB28E2FAC54EFE032)
* [ How Linear Allocation will work as of July 19, 2018 ](m_metric_type_alloc.md#section_EDBB2E14A6C248C5A79C0913C02D7CA1)

## Metric Type {#section_34A86FB402F94E988724232283BF18B7}

![](graphics/cm_type_alloc.png) 
...
<table id="table_2118C64DB0404767A6277B7BFFAAD76F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>All variable values within the visit of the success event receive equal divided credit. If the success event was a currency amount, the currency is split. If it is a counter event, each conversion variable value receives a fraction of the single instance. These fractions are summed then rounded in reporting. </p> <p>For more information on how linear allocation will change in the near future, see <a href="m_metric_type_alloc.xml#concept_B7A1FCFEFA9D4C4883208ACE8C9C8E5E/section_EDBB2E14A6C248C5A79C0913C02D7CA1" format="dita" scope="local"> How Linear Allocation will work as of July 19, 2018 </a>. </p> </td> 
  </tr> 
  <tr> 
