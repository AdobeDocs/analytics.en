...
| --- | --- |
| **March 2025** |  |
| Updated information about IP exclusions | Added information explaining that IP exclusions can take up to 5 minutes before they take effect, and that changes apply only to new hits (data captured prior to the exclusion being set is not affected). <p>Also updated the layout of content to improve readability.</p>  |
| **February 2025** |  |
