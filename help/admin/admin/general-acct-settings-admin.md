...
|Conversion Level|Enables or disables e-commerce variables such as eVars and campaigns. Use the  Enabled, no Shopping Cart option to hide all shopping cart reports if you don't have a shopping cart on your site.|
