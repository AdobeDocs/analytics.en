...
>[!NOTE]
>
>Virtual rport suites are managed via **[!UICONTROL Analytics]** > **[!UICONTROL Components]** > **[!UICONTROL Virtual report suites]**. Please refer to the [Virtual report suite documentation](/help/components/vrs/vrs-about.md).
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A rollup is single report suite that combines the tracking data of several other report suites. </p> <p>See <a href="/help/admin/admin/c-manage-report-suites/rollup-report-suite.md"> Rollup Report Suites</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">See <a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> New Report Suite</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Identifies report suites in Admin Tools, and in the report suite drop-down list in the marketing report header. </p> <p>See <a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> New Report Suite</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> Base URL</span> </td> 
   <td colname="col2"> <p>Defines the base domain for the report suite. </p> <p>See <a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> New Report Suite</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
