...
seo-title: Map
title: Map
uuid: d947dfdd-27a1-4cb7-a44b-153dc302788a
index: y
internal: n
snippet: y
translate: y
...
* [ Overview ](map-visualization.md#section_19F740FAF08D47B1AF1EF239A74FC75C)
* [ Build a Map Visualization ](map-visualization.md#section_61BBFA3A7BFD48DA8D305A69D9416299)
* [ Map Visualization Settings ](map-visualization.md#section_5F89C620A6AA42BC8E0955478B3A427E)
...
1. From the list of visualizations, drag ** [!UICONTROL  Map] ** into a Freeform panel: ![](graphics/map-viz1.png) 
...
1. Click ** [!UICONTROL  Build] **. The first view you will see is a World View with a bubble map, similar to this. 
   ...
   ![](graphics/bubble-world-view.png) 
...
1. You can now 
    ...
    * **Toggle** to a different view, such as the heat map, using the [ settings ](map-visualization.md#section_5F89C620A6AA42BC8E0955478B3A427E) described below. Note that the bubble view is the default setting.

1. **Save** the project to save all map settings (coordinates, zoom, rotation).
1. The freeform table, below the visualization, can be populated by dragging in location dimensions and metrics from the left rail: ![](graphics/location-dimensions.png) 
