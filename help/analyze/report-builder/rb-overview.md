...
Report Builder for Adobe Analytics is a Microsoft Excel add-in. The add-in is available on the following platforms:
...
This Report Builder replaces the [legacy Report Builder add-in](/help/analyze/legacy-report-builder/home.md) and has several benefits:
...
### Legacy Report Builder features not supported

Some [features of the legacy Report Builder are not supported](convert-workbooks.md#legacy-report-builder-features-not-supported) in this Report Builder.
...
>[!IMPORTANT]
>
>This overview video shows the Report Builder user interface in Customer Journey Analytics. Some of the user interface and terminology differ when you use the Report Builder in Adobe Analytics. Otherwise, the user experience is identical.
...
You can download Report Builder from Adobe Analytics from the [Microsoft Store](https://appsource.microsoft.com/en-us/product/office/WA200003101?tab=Overview).
