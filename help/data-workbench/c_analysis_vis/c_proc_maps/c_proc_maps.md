...
uuid: 2cc174f1-c819-4314-8b76-64ea4eb7812e
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>For these maps to work most effectively, you should open a color legend in the workspace. For information about using color legends with process maps, see [Activating Color Links](../../c_analysis_vis/c_proc_maps/c_act_color_lnks.md#concept_2C9B9F67F2BD4CD7A5431FA21C094EDC). For more information about color legends, see [Color Legends](../../c_analysis_vis/c_legends/c_color_leg.md#concept_F84D51DC0D6547F981D0642FC2D01358).
...
>[!NOTE]
>
>You can change the default dimensions or metric for a process map. For steps to configure a process map, see [Configuring Process Maps](../../c_intf_anlys_ftrs/t_config_proc_maps.md#task_4A95730B18A14BC790A77C013832B2D6).
