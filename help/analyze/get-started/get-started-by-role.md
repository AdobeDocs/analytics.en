...
The [implementation method](/help/implement/home.md) you choose determines the type of data that can be gathered.
...
For information about each available method, see [Implement Adobe Analytics](/help/implement/home.md).
...
|---------|----------|---------|
| Define administrator roles | Adobe Analytics supports various types of administrators | [Administrator roles in Adobe Analytics](/help/admin/admin-console/admin-roles-in-analytics.md) |
| Define permissions | Analytics administrators need to assign product profiles in the Admin Console for Adobe Analytics, Report Suite Tools, and Analytics Tools. | [Analytics Permissions in the Admin Console](/help/admin/admin-console/permissions/analytics-tools.md) |
| Set up report suites and define settings for your company | A report suite is a silo of data that Adobe Analytics uses to generate reports.<p>Administrators can also set up [virtual report suites](/help/components/vrs/vrs-about.md) to further segment data.</p> | <ul><li>[Create a report suite](/help/admin/tools/manage-rs/new-rs/t-create-a-report-suite.md)</li><li>[Company Settings Overview](/help/admin/tools/company/c-company-settings.md)</li></ul> |
| Import data | Adobe Analytics data sources let you import additional online or offline data for reporting.  | [Data sources overview](/help/import/data-sources/overview.md) |
| Classify data with Classifications | Classifications allow you to classify data to make better use of variables, allowing you to include more content into a single variable. | [Classifications overview](/help/components/classifications/classifications-overview.md) |
| Manage components | Use the Data Dictionary and the management areas for each component type to define which components are available in your Analytics implementation, as well as which are approved for your organization.<p>This should be an ongoing activity to ensure that components are being used effectively in your organization. </p>| <ul><li>[Data Dictionary overview](/help/analyze/analysis-workspace/components/data-dictionary/data-dictionary-overview.md)</li><li>[Calculated metrics manager](/help/components/calculated-metrics/workflow/cm-manager.md)</li><li>[Manage segements](/help/components/segmentation/segmentation-workflow/seg-manage.md)</li><li>[Create custom date ranges](/help/analyze/analysis-workspace/components/calendar-date-ranges/custom-date-ranges.md)</li></ul> |
| Anomaly detection | Anomaly Detection provides a statistical method to determine how a given metric has changed in relation to previous data. | [Anomaly Detection overview](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md) |
| Contribution analysis | Contribution Analysis discovers hidden patterns within your data to explain statistical anomalies and identify correlations behind unexpected customer actions, out-of-bound values, and sudden spikes or dips for selected metrics across convergent audience segments. | [Contribution Analysis overview](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md#contribution-analysis) |
| Analytics segmentation | Lets you build, manage, share, and apply powerful, focused audience segments to your reports using Analytics capabilities, the Adobe Experience Cloud, Adobe Target, and other integrated Adobe products. | [Analytics segmentation](/help/components/segmentation/seg-home.md) |
| Publish audiences to Audience Manager | Adobe Audience Manager is a powerful data management platform that helps you build unique audience profiles from first-party, second-party (partner), and third-party data integrations.  | [Audience Analytics overview](/help/integrate/c-audience-analytics/mc-audiences-aam.md) |
| Integrations | You can surface information from other applications in Adobe Analytics. <p>Following are some common integrations:</p><ul><li><a href="/help/analyze/analysis-workspace/c-panels/a4t-panel.md">Analytics for Target</a></li><li><a href="https://experienceleague.adobe.com/en/docs/media-analytics/using/media-overview">Streaming media services</a></li>  | [Analytics Integration](/help/integrate/home.md)|
...
| Log files | Log files to help you see when users log in, their usage, access, report suites, and Admin changes. | [Logs](/help/admin/tools/logs.md) |
...
| Anomaly detection | Statistical modeling in Analysis Workspace automatically finds unexpected trends in your data by analyzing metrics and determining a lower bound, upper bound, and expected range of values. When an unexpected spike or drop occurs, the system alerts you in the report. | [Anomaly Detection overview](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md) |
| Contribution analysis | Use Analysis Workspace to discover hidden patterns within your data to explain statistical anomalies and identify correlations behind unexpected customer actions, out-of-bound values, and sudden spikes or dips for metrics across audience segments. | [Contribution Analysis](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md#contribution-analysis) in [Anomaly Detection overview](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md) |
| Alerts | Create and manage alerts based on data anomalies and "stacked" alerts that capture multiple metrics in a single alert. | [Alerts overview](/help/components/alerts/alerts-overview.md) |
| Data export | Data Warehouse and Data Feeds allow you to export data to various cloud destinations, such as Google Cloud Platform, Azure RBAC, Azure SAS, and Amazon S3. | [Analytics Export Guide](/help/export/home.md) |
