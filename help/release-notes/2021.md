...
| Dark Theme | [Dark theme](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/user-preferences.html#dark-theme) is available as a display option. | October 21, 2021 |
