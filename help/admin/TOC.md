...
+ [Admin Tools](admin/admin.md)
    ...
    + [Bot Rules](admin/bot-rules.md)
    + [Code Manager](admin/code-manager-admin.md)
    + [Conversion Variables (eVar)](admin/conversion-var-admin.md)
    ...
    + [Paid Search Detection](admin/paid-search-detection.md)
    ...
    + [Real-time reports configuration](admin/t-realtime-admin.md)
...
+ [Data Governance](c-data-governance/c-data-governance.md)
    ...
    + [GDPR labels for Adobe Analytics variables](c-data-governance/gdpr-labels.md)
