...
|VISTA|Enables you to apply server-side logic to alter or segment data as it is collected. | [VISTA rules](https://docs.adobe.com/content/help/en/analytics/admin/admin-tools/processing-rules/processing-rules-configuration/processing-rule-order.html)|
