...
topic: Admin tools
uuid: 6cccfb93-b01f-4e67-8191-2f7045a4e151
index: y
internal: n
snippet: y
---
...
A group is a collection of users that you want to give a common set of access and permissions. For example, if you have 50 marketing report users, but only 20 need access to ad hoc analysis, you can create a group for those 20 users.
 ...
 See [Groups](../../admin/user-management2/c-user-groups/groups.md#concept_6C565553DCE3417C909234B2F044A02F) in *User Management* for configuration information. 
