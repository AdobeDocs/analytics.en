...
|Bot rules|[Bot rules](../../../../admin/admin/bot-removal/bot-rules.md) let you remove traffic that is generated by known spiders and bots from your report suite.|
...
|Marketing Channel Processing Rules|You can use processing rules to prepare data for processing by [Marketing Channel Processing Rules](https://marketing.adobe.com/resources/help/en_US/mchannel/c_rules.html).|
