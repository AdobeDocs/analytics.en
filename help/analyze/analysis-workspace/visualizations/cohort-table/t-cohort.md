...
Like other visualizations in Analysis Workspace, you can download a cohort visualization as a CSV or PDF file. For more information, see [Download PDF or CSV files](/help/analyze/analysis-workspace/curate-share/download-send.md).
