...
uuid: e509d9b9-20e2-472d-84f2-aab6a88cbb36
index: y
internal: n
snippet: y
---
...
The hierarchy view displays the pages in a website organized hierarchically by file name and sorted alphabetically. While useful for analysis itself, the hierarchy view also can be used to set up such advanced visualizations as process maps. For more information about process maps, see [Process Maps](../../c-analysis-vis/c-proc-maps/c-proc-maps.md#concept_880AEE224404429785B733A4E80D275E).
