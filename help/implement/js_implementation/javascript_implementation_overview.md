...
uuid: db71be80-79df-46df-8e92-af996b2b2fe6
index: y
internal: n
snippet: y
---
...
The easiest and recommended way to send data to [!DNL Analytics] is by using [Dynamic Tag Management](../c_implement-with-dtm/c_implement-with-dtm.md#concept_90C125C03E024A9A9A1D7F47B3CCF4B5). However, in some cases, you might want to implement Analytics using the older JavaScript method.
...
&nbsp;==============&nbsp;DO&nbsp;NOT&nbsp;ALTER&nbsp;ANYTHING&nbsp;BELOW&nbsp;THIS&nbsp;LINE&nbsp;!&nbsp;============
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Copy the <a href="../js_implementation/appmeasure_mjs_pagecode.md#section_4351543F2D6049218E18B48769D471E2" format="dita" scope="local"> Example AppMeasurement.js Code </a> and paste it at the beginning of your <span class="codeph"> AppMeasurement.js </span> file. At a minimum, update the following variables: </p> 
...
src="http://INSERT-DOMAIN-AND-PATH-TO-CODE-HERE/AppMeasurement.js"&gt;&lt;/script&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Copy the <a href="../js_implementation/appmeasure_mjs_pagecode.md#section_042412C29CC249E298F19B2BC2F43CE7" format="dita" scope="local"> Example Page Code </a> and paste it just after the opening <span class="codeph"> &lt;body&gt; </span> tag on each page you want to track. At a minimum, update the following variables: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Install the <a href="../impl_testing/debugger.md#concept_B26FFE005EDD4E0FACB3117AE3E95AA2" format="dita" scope="local"> Adobe Debugger </a> bookmarklet. After it is installed, load a page where you have deployed page code and then open the debugger. The debugger displays details about the collection data that was sent. </p> </td> 
  </tr> 
 </tbody> 
</table>
