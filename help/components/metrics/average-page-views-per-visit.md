...
>[TIP] Use this metric alongside another metric (such as [Visits](visits.md)) to obtain better insights. If you use this metric by itself, you get dimension values containing anomaly page views per visit, which is typically not valuable.
