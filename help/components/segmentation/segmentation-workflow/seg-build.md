...
1. To publish your segment to the CX Enterprise, select **[!UICONTROL Publish this segment to the  CX Enterprise (for *report suite*)]**. See [Publish segments to CX Enterprise](/help/components/segmentation/segmentation-workflow/seg-publish.md) for more information.
1. Select:
...
1. **[!UICONTROL CX Enterprise publishing]**: Publishing an Adobe Analytics segment to the CX Enterprise lets you use the segment for marketing activity in [!DNL Audience Manager] and in other activation channels. [Learn more...](/help/components/segmentation/segmentation-workflow/seg-publish.md)
1. **[!UICONTROL Audience library]**: Adobe's audience services manage the translation of visitor data into audience segmentation. As such, creating and managing audiences is similar to creating and using segments, with the added ability to share the audience segment to the CX Enterprise. [Learn more...](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html)
