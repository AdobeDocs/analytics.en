...
| **Updated navigation to Customer Attributes UI**  |  The Customer Attributes user interface is now accessible directly from the app selector in Adobe CX Enterprise. Please select **[!UICONTROL Customer Attributes]** from the drop-down menu (instead of going to [!UICONTROL People] > [!UICONTROL Customer Attributes]) and update your bookmarks.  The update includes some improvements to the UI.  | July 1, 2025 |  July 31, 2025 |
...
| **Updated navigation to Customer Attributes UI**  |  The Customer Attributes user interface is now accessible directly from the app selector in Adobe CX Enterprise. |  |  TBD |
