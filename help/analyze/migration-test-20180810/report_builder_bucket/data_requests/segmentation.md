...
uuid: fd3b8147-d38c-4a52-ac71-e19d67ed8bdf
index: y
internal: n
snippet: y
translate: y
...
* [ Add or edit segments ](segmentation.md#section_B2BC136F9A53498D90C7C2ECC5DB892B)
* [ Create in-context segments ](segmentation.md#section_6DD2C663B2854469AA1075438F907678)
* [ Search for and apply segments ](segmentation.md#section_CACA269B48E94CFD91C2D5A15E9C77B7)
* [ Filter segments ](segmentation.md#section_376E986D3E684999A7CDB08E53854159)
* [ Add a segment control to a workbook ](segmentation.md#section_E3E5149A8464441FA5445A98DBD520AC)
* [ Refresh the list of segments ](segmentation.md#section_22E4A86789444B4A998532396B476EFB)
* [ Manage segments across requests ](segmentation.md#section_C3D63FCBE1A94369A319243313B03C93)


![](Graphics/seg_dialog.png) 
...
1. Right-click to select ** [!UICONTROL  Create In-Context Segment in] ** and specify the right container (Hits Container, Visits Container, Visitor Container). ![](Graphics/seg_in_context.png) 
...
Any segments that were created in Reports &amp; Analytics, Ad Hoc Analysis, Report Builder, or Data Warehouse appear in this segment list. To refresh the list, click the Refresh icon (  ![](Graphics/refresh_icon.png)). 

You can apply one or multiple segments to any given request. This includes sequential segments. 
1. Go to the ** [!UICONTROL  Segment] ** drop-down list and click the small down arrow in the ** [!UICONTROL  Choose Segment] **box to display all the segments. ![](Graphics/seg_list.png) 
...
**Filter** segments by clicking on the Filter icon:  ![](Graphics/segment_filter.png) 
...
1. Click the Control icon (  ![](Graphics/control_icon.png)) next to the segment drop-down. ![](Graphics/seg_control.png) 
...
1. Click ** [!UICONTROL  OK] ** and the segment control appears in the specified location. ![](Graphics/seg_control2.png) 


## Refresh the list of segments {#section_22E4A86789444B4A998532396B476EFB}

Any time you add a new segment or edit an existing one, you should click the Refresh icon (  ![](Graphics/refresh_icon.png)) to refresh the cached list of segments. 
...
1. Right-click and select ** [!UICONTROL  Edit Requests] ** > ** [!UICONTROL  By Segment] **. ![](Graphics/edit_by_segment.png) 
