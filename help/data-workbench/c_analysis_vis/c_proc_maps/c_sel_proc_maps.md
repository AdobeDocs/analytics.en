...
uuid: 9416a33b-19a6-46c7-bfaa-8a0ee9c1b0d9
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>You can change the default group dimension for a process map. See [Configuring Process Maps](../../c_intf_anlys_ftrs/t_config_proc_maps.md#task_4A95730B18A14BC790A77C013832B2D6).
...
When you make a selection in a 3D process map, the node for which the selection is made is circled. Benchmarks appear around each bar help you compare metric values with and without the selection. See [Understanding Benchmarks](../../c_vis/c_ustd_benchmks.md#concept_C7B0F4102E92458096F8C4765CBE2914).
