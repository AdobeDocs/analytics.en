...
| ----------- | ---------- | ---- |
| **Activity Map improvements**<br/>Activity Map includes the following enhancements:</p><ul><li>Support for the Activity Map Overlay extension with Web SDK implementations of Adobe Analyticcs.</li><li>Support for WebSDK tracking (when the tracking goes to Analytics).</li><li>Updated styling throughout the user interface.</li></ul><p>(Documentation link to follow.)</p> | | April 2026 |
| **MCP servers for Adobe Analytics** <br/>You can now tie Adobe Analytics into your existing agentic workflows using MCP (Model Context Protocol). You can request reports and insights using natural language. | | End of April 2026 |
