...
uuid: 01bd64a3-0d17-4495-a5b1-b38d9c2ba1a0
index: y
internal: n
snippet: y
---
...
>[!IMPORTANT]
>
>Which visualization settings are visible depends on the visualization. Not all settings apply to all visualizations. In addition, some advanced settings appear **only** for specific visualizations, such as the [Histogram settings](../../analysis-workspace//histogram.md#section_09D774C584864D4CA6B5672DC2927477).
