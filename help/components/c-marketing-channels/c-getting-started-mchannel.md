...
uuid: 208ac419-81bf-4c49-8f13-c57021c00705
index: y
internal: n
snippet: y
---
...
A list of recommended channels can be found in [Frequently Asked Questions and Examples](../../components/c-marketing-channels/c-faq.md#concept_72CE3270AC264DB2A64BCB3E4B0D9C44). Create a list of channels you want to use, so that enabling and defining them is easier when you create channels.
