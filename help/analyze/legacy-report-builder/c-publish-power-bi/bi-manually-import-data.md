...
1. Under **[!UICONTROL Import or Connect to Data]** > **[!UICONTROL Files]**, click **[!UICONTROL Get]**.
   ...
   ![Click the Get icon under Import or Connect to Data.](assets/get-data.png)

1. Click Local File.

   ![Click the Local File icon.](assets/local-file.png)
...
1. Click **[!UICONTROL Upload]** under **[!UICONTROL Upload your Excel file to Power BI]**.
   ...
   ![Click Upload to upload your Excel file.](assets/upload-excel-file.png)
