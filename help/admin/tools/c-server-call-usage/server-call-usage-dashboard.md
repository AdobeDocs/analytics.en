...
* Compares current usage (green line) to your contractual usage limit (red line).
  ...
  ![](/help/admin/tools/c-server-call-usage/assets/current_period.png)
...
* Compares your current period's usage to last year's usage (blue line). Obviously, the blue line will only appear if your company has server call usage data from the previous year.
  ...
  >[!NOTE]
  >
  >If you want to view usage for a previous time period, you have to go to the [Report Suite Usage](/help/admin/tools/c-server-call-usage/report-suite-usage.md) tab and download the usage data for a previous period.
...
![](/help/admin/tools/c-server-call-usage/assets/server_call_dashboard.png)

|  UI Term  | Definition  |
| --- | --- |
|  Current Period Usage (green)  |The current period is based on the [usage period](/help/admin/tools/c-server-call-usage/overage-overview.md).  |
