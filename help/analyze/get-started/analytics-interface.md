...
2. Select any of the following product features to configure it: 
   ...
   | Alerts | Alerts allow for more granular control over alerts and integrates anomaly detection with the alert system. | [Alerts overview](/help/components/alerts/alerts-overview.md) |
...
2. Select any of the following product features to configure it:   
   ...
   | Data Governance Privacy Labeling | Labeling report suite data means that you assign identity, sensitivity, and data governance labels to each variable in a given report suite.  | [Privacy labeling](/help/admin/tools/privacy-labeling/labeling-overview.md) |
