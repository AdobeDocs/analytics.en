...
## Manage legacy scheduled workbooks

For information about managing legacy workbooks that are already scheduled, see [Convert scheduled workbooks](/help/analyze/report-builder/convert-workbooks.md#schedule-a-converted-legacy-workbook).
