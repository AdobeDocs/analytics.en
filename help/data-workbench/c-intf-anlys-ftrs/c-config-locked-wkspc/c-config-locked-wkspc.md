...
uuid: ef74172b-da0f-4a20-80f8-3796a655e7cf
index: y
internal: n
snippet: y
---
...
For information about [!DNL folder.lock] and workspace [!DNL name.lock] files, see the following section. For information about setting the Unlock parameter, see [Setting the Unlock Parameter](../../c-intf-anlys-ftrs/c-config-locked-wkspc/c-unlck-param.md#concept_B018A85C6217489AA01B17845872DF7F). For information about the [!UICONTROL Temporarily Unlock menu] option, see [Unlocking a Workspace](../../c-get-started/c-work-worksp/c-unlock-wksp.md#concept_18ADA952AECF45C79A806B31B294023E). 
