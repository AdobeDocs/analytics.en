---
title: How to select a data range in Report Builder in Adobe Analytics
description: Describes how to use the calendar, rolling dates, and custom expressions in Report Builder for Adobe Analytics
role: User
