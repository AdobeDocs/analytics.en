...
uuid: ada8fda7-fdfd-429f-ab07-a133fadfb98e
index: y
internal: n
snippet: y
---
...
In addition to the procedures listed in the following sections, you can perform all of the same tasks that you can perform in a table, such as sort elements, mask elements, add a series legend, export data, and so on. For more information, see [Tables](../../data-workbench-client/c-analysis-vis/c-tables/c-tables.md#concept_C632CB8AD9724F90AC5C294D52AE667F).
...
>[!NOTE]
>
>Events that you select do not persist unless you save the selections as a latency dimension. For steps, see [Reusing a Latency Dimension](../../data-workbench-client/c-analysis-vis/c-lat-tbls.md#section_29C6483BF9BA476FB1C24AD1DF253F46).
