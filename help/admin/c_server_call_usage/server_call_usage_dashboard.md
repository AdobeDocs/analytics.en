...
uuid: 76bc0238-6a90-45ab-93ec-0ef7cfd57298
index: y
internal: n
snippet: y
---
...
* Compares your current period's usage to last year's usage (blue line). Obviously, the blue line will only appear if your company has server call usage data from the previous year. 
  ...
  >[!NOTE]
  >
  >If you want to view usage for a previous time period, you have to go to the [Report Suite Usage](../c_server_call_usage/report_suite_usage.md#concept_E50FA5BD93404EB8B2FE954F658FDAFD) tab and download the usage data for a previous period.
...
|  UI Term  | Definition  |
|---|---|
|  Current Period Usage (green)  |The current period is based on the [usage period](../c_server_call_usage/overage_overview.md#section_CBA348A039F34563B097CD8890AB358D).  |
