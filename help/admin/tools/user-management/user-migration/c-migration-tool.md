...
<table id="table_E4465796E224474680D750CAC5434ED3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Analytics users can sign in to the CX Enterprise and all solutions using their Adobe ID or Enterprise ID. This sign-in enables access to integrated solutions and core services in the CX Enterprise. </p> <p>After the migration, users who attempt to sign in via legacy logins (<span class="filepath"> my.omniture.com</span> and <span class="filepath"> sc.omniture.com</span>) are redirected to <span class="filepath"> experiencecloud.adobe.com</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Verify that you have an Adobe ID and can access the <a href="https://adminconsole.adobe.com/enterprise/"> CX Enterprise Admin Console</a>. </p> <p>If not, contact <a href="https://helpx.adobe.com/marketing-cloud/contact-support.html"> Adobe Customer Care</a>. (You should first contact your system or product administrator who can invite you to the proper organization.) </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe will notify Analytics administrators via email with instructions about when the migration will begin. </p> <p>Migrations to the Adobe Admin Console will occur in waves. On the day of migration, Adobe notifies Analytics administrators and grants them access to the migration tool. After a login company meets the criteria defined for each migration wave, Adobe will: </p> 
    ...
    <ul id="ul_4639963EB08F407F8C18ACE2B3D30223"> 
     ...
     <li id="li_5B5234D4F94A4B96A8920F6A5831A64C">Users will access Analytics using their Adobe or Enterprise ID through the CX Enterprise instead of <span class="filepath"> my.omniture.com</span>. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table id="table_0E37BB1DEA6143F0B5F4E861FCFA7189"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Once your migration begins, any administrator that accesses your Analytics instance via the CX Enterprise can use the migration tool to begin (or continue) migrating users. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Yes. Users migrated using the tool will be accorded the permissions they currently have in Analytics. Furthermore, they will retain access to their Analytics assets (like segments, projects, calculated metrics, and so on) when they access Analytics via the CX Enterprise. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>They will receive a welcome email addressed to the email ID in their Analytics user record, notifying them about their new way to access Analytics via the CX Enterprise. If they do not have an existing Adobe ID, they will be prompted to create one, after which they can access the solution using their Adobe ID. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>These will remain available to you in Analytics user management. </p> <p>See <a href="/help/admin/tools/user-management/user-migration/c-migration-tool.md"> Unsupported Analytics features in the Adobe Admin Console</a> for more information. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>After the migration end date (60 days from the start of the migration), all users within your login company are redirected to login via the CX Enterprise login page using their Adobe IDs. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Users that have not been migrated by the end date will be redirected to the CX Enterprise login page (experiencecloud.adobe.com) and will be unable to access Analytics. However, you will continue to have access to the migration tool so you can find and migrate them to restore their access. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_88E2FA03D5F241B79AB54D12F64B51DA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Details around a users' last-login date and time will be available in the Analytics Users and Assets link and not the Adobe Admin Console. The last-login date in Analytics is specific to when users actually accessed Analytics from within CX Enterprise and does not reflect the date/time when they logged into the CX Enterprise. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Single Sign-On </p> </td> 
   <td colname="col2"> <p> Analytics single sign-on configurations will be removed when you have completed the migration. They will remain active during the migration. Customers that use Analytics single sign-on should upgrade to <a href="https://helpx.adobe.com/enterprise/help/identity.html"> Adobe Federated ID</a>. </p> <p>Analytics recommends that you migrate your users as Adobe IDs first to easily create the CX Enterprise accounts, and then convert those accounts to Federated single-sign users. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bulk email to users will no longer be supported in either the Analytics Admin Tools or the Adobe Admin Console. Customers can bulk export their users' email addresses from Adobe Admin Console and send an email using any email client they wish. </p> </td> 
  </tr> 
 </tbody> 
</table>
