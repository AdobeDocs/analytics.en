...
uuid: edcbf502-f068-4f10-946b-36f90c74cbd6
index: y
internal: n
snippet: y
---
...
Statistical correlations measure meaningful relationships to identify opportunities through advanced data mining.
 ...
 The Correlation Matrix uses [Pearsons correlation coefficient](../../c-analysis-vis/c-correlation-analysis/c-correlation-pearsons.md#concept_5996CB8C89FD4DF5B47B7318E7A1D29C) to better identify the next steps in a marketing campaign, to improve site design, or to continue in-depth customer analysis for additional correlation dependencies.
...
1. Create a [Binary Filter](../../c-analysis-vis/c-correlation-analysis/c-correlation-binary-filter.md#concept_24E1DAFF43C540F69019F236976DA31C) to further constrain the metric by right-clicking the metric in the table and select **[!UICONTROL Binary Filter]**from the menu.
...
**Statistical correlations are not equal to the Correlated Data Model**, the historical reference of Adobe Analytics products. The statistical correlation in Data Workbench is based on the [Pearson Correlation model](../../c-analysis-vis/c-correlation-analysis/c-correlation-pearsons.md#concept_5996CB8C89FD4DF5B47B7318E7A1D29C).
