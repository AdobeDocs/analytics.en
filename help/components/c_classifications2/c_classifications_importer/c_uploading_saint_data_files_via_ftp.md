...
title: FTP import
topic: Admin tools
uuid: 67579179-251a-4bd7-b0a0-3ef20e000009
index: y
internal: n
snippet: y
---
...
Before uploading data via FTP, create an FTP account. For more information, see [Create an FTP account](../../c_classifications2/c_classifications_importer/c_uploading_saint_data_files_via_ftp.md#task_C019268E6C934C7C95F4326F42A22CCF). 
...
For more information about creating an FTP account, see [Create an FTP account](../../c_classifications2/c_classifications_importer/c_uploading_saint_data_files_via_ftp.md#task_C019268E6C934C7C95F4326F42A22CCF). 
...
t_create_an_ftp_account.xml
 ...
 -->
>See [FTP and sFTP](http://marketing.adobe.com/resources/help/en_US/whitepapers/ftp/) for additional details on Adobe FTP servers. 
>
>1. Click **[!UICONTROL Admin]** > **[!UICONTROL Classification Importer]**.
>1. Click **[!UICONTROL Import File]**, then click **[!UICONTROL FTP Import]**.
