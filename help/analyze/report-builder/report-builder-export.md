...
1. In the [!UICONTROL **Adobe Report Builder**] right panel, specify the following information:
   ...
   | **[!UICONTROL Email]** | Select this option to send the file to a specific email address. For more information about this option, see [Schedule workbooks for sharing through email](/help/analyze/report-builder/schedule-reportbuilder.md). |
