...
* The following metrics can be used in this report (depending on organization and report suite settings):
    ...
    * [New Engagements](https://docs.adobe.com/content/help/en/analytics/components/variables/metrics/metrics-new-engagements.html): the number of visitors who have received a new First Touch Channel.
