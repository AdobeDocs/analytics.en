...
![](/help/admin/tools/c-server-call-usage/assets/alerts.png)
...
1. Click **[!UICONTROL + Add]** and select **[!UICONTROL Server Call Usage Alert]**.
   ...
   ![](/help/admin/tools/c-server-call-usage/assets/server_call_alert.png)

1. Define the alert.

   ![](/help/admin/tools/c-server-call-usage/assets/sc_alert.png)
...
![](/help/admin/tools/c-server-call-usage/assets/alert_mgmt.png)
...
1. Complete one or more of these actions: 
   ...
   | Action | Definition |
   |--- |--- |
   |+ Add|Access the [Alert Builder](/help/admin/tools/c-server-call-usage/scu-alerts.md) by clicking  [!UICONTROL + Add].|
   ...
   |Export to CSV|See [Download Usage Report](/help/admin/tools/c-server-call-usage/report-suite-usage.md)|
