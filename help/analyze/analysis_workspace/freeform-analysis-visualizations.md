...
uuid: cac66257-8f0d-48b9-befc-e3e7d8c501c8
index: y
internal: n
snippet: y
---
...
>[!IMPORTANT]
>
>Which visualization settings are visible depends on the visualization. Not all settings apply to all visualizations. In addition, some advanced settings appear **only** for specific visualizations, such as the [Histogram settings](../../analysis_workspace//histogram.md#section_09D774C584864D4CA6B5672DC2927477).
