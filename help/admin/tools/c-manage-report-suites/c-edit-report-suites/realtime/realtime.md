...
>[!NOTE]
>
>The Real-Time Report requires no additional implementation or tagging. It leverages your existing implementation of Adobe Analytics. To configure real-time reports, see [Real-Time Reports Configuration](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/realtime/t-realtime-admin.md).
...
![](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/realtime/assets/report-realtime.png)
...
Keep in mind that eVars (conversion metrics) are not supported, since there is no concept of persistence. While you can select conversion metrics, they only work if they are set on the same page as the dimension(s). For more information, see the warning message captured in [Setting up Real-Time Reports](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/realtime/t-realtime-admin.md).
