...
uuid: 38818f53-1a7d-420e-8d4d-acfa00f41b0a
index: y
internal: n
snippet: y
translate: y
...
To protect a workbook against editing, click ** [!UICONTROL  Locked] ** on the Report Builder toolbar ( ![](Graphics/locked_icon.png)). 

To unprotect a workbook, click ** [!UICONTROL  Unlocked] ** ( ![](Graphics/unlocked_icon.png)). 
...
* If you do not have permissions to unlock the request(s), this prompt appears: ![](Graphics/locked_workbook_error.png) 
