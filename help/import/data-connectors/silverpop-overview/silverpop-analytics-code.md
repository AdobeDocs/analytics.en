...
>[!NOTE] The plug-in above assumes certain Custom Commerce Variables (eVars) are available. If the variables specified in the plug-in above are not available within your Analytics deployment, simply replace them with those that are available.
