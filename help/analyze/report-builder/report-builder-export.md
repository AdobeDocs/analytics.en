...
1. In the [!UICONTROL **Adobe Report Builder**] right panel, specify the following information to continue creating a new schedule:
   ...
   | **[!UICONTROL Email]** | Select this option to send the file to a specific email address. For more information, see [Schedule workbooks by sharing through email](schedule-reportbuilder.md). |
