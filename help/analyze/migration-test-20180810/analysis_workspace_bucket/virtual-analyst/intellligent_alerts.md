...
uuid: da27af31-bf36-42d6-a0e5-e11d717f2d00
index: y
internal: n
snippet: y
translate: y
...
* [ Overview ](intellligent_alerts.md#section_6AC8CA81DEA94E99B0F192B60D0FDF03)
* [ FAQ: How Alerts are Calculated and Triggered ](intellligent_alerts.md#section_1F3B1DAF21784306953B49AAD4C3DCAB)
...
* By selecting one or more freeform table line item/s, right-clicking and selecting ** [!UICONTROL  Create Alert from Selection] **. This will open the Alert Builder and will pre-populate the builder with the appropriate metrics and filters applied from the table. You can then edit the alert, if needed. ![](graphics/create-alert-from-selection.png) 

* From within a Reports &amp; Analytics report, by going to  ** [!UICONTROL  More] ** > ** [!UICONTROL  Add Alert] ** . This will open the new Alert Builder and will pre-populate the builder with the appropriate metrics and filters applied from the report. You can then edit the alert, if needed. ![](graphics/add-alert.png) 
...
<table id="table_B3AA85E1DE3543DCA34966A52E3CE4AB"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>The training period varies based on the granularity selected. (See <a href="statistics_anomaly_detection.xml#concept_0705DC91F0F44951AC2226EC846E824C" format="dita" scope="local"> Statistical Techniques used in Anomaly Detection </a> for more detail.) Here is a summary: </p> 
