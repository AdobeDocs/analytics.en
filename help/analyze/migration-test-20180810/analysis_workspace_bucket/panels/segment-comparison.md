...
uuid: 1cc37497-bef8-4162-a850-3d1886dbc885
index: y
internal: n
snippet: y
translate: y
...
![](graphics/population summaries.png) 
...
For details on how the difference scores of each table are calculated, refer to [ Statistical Tests Used in Segment Comparison ](statistical-test.md#concept_0B6AC754EAED460283D4626983F838F4). 
...
![](graphics/top-dimension-item1.png) 
...
![](graphics/top-dimension-item.png) 
...
Click here for more information on the [ statistical tests ](statistical-test.md#concept_0B6AC754EAED460283D4626983F838F4) used in comparing segments. 
