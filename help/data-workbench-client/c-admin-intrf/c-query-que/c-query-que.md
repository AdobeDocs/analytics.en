...
uuid: 654b2b37-a1f7-42cf-8b87-d0a11143e20c
index: y
internal: n
snippet: y
---
...
1. Configure the following parameters:
    ...
    * **User Groups:** Lets you configure policies, users, and the queue priority. See [Query Queue User Groups](../../../data-workbench-client/c-admin-intrf/c-query-que/c-query-que-user-grps.md#concept_5555F51402ED49419C067D61738474C1) for definitions. 
