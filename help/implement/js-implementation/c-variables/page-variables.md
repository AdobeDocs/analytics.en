...
uuid: 831fcddd-832a-48d5-9c7a-56915ff7d56a
index: y
internal: n
snippet: y
---
...
You may read these values and copy them into [!DNL props/eVars], but you should never alter them. This variable is introduced with version H.11 of the JavaScript file.
...
* The [!UICONTROL getQueryParam] plug-in, used in the JavaScript file, retrieves a query string parameter from the URL. For more information on the [!UICONTROL getQueryParam] plugin, see [Implementation Plug-ins](../../js-implementation/c-mplementation-plug-ins/impl-plugins.md#concept_021F5E4A6BD745AE91E85E7138BE930F). 
...
* To keep click-throughs from being inflated, use the [!UICONTROL getValOnce] plugin to let the click-through for a campaign be counted only once per session. For more information on the [!UICONTROL getValOnce] plug-in, see [Implementation Plug-ins](../../js-implementation/c-mplementation-plug-ins/impl-plugins.md#concept_021F5E4A6BD745AE91E85E7138BE930F). 
...
>[!NOTE]
>
>The dc variable is deprecated. You should set *`trackingServer`* for all implementations to the value that is generated by [!UICONTROL Code Manager] in [!DNL s_code.js].
...
|  Max Size  | Debugger Parameter  | Reports Populated  | Default Value  |
|---|---|---|---|
|  255 Bytes  | V1-v75 ( [or v100 or v250](../../js-implementation/c-variables/page-variables.md#concept_558663F3B8164986AB5D94128FEA7B28))  | Custom Conversion  | ""  |
...
While eVars may be renamed, they should always be referred to in the JavaScript file by eVarX, where X is a number between 1 and 75 ( [or 100, or 250](../../js-implementation/c-variables/page-variables.md#concept_558663F3B8164986AB5D94128FEA7B28)).
...
See [Event Serialization](../../js-implementation/event-serialization.md#concept_092B638D7FEE423D91F8A57EA8E09705) for more information.
...
Custom links send data to [!DNL Analytics]. The *`linkType`* variable (or the second parameter in the *`tl()`* function) is used to identify the report in which the link name or URL appears ( [!UICONTROL Custom], [!UICONTROL Download], or [!UICONTROL Exit Links] report).
...
* List props are enabled only on traffic variables ( [props](../../js-implementation/c-variables/page-variables.md#concept_0F10FA2DE69B4029A31EA5E9313AA254)). 
...
* Any custom traffic variable can become a list prop. (Exceptions: [pageName](../../js-implementation/c-variables/page-variables.md#concept_5827B499DAC34B5D8445F9D9140CC328), [channel](../../js-implementation/c-variables/page-variables.md#concept_C7770B8C15724A99B10F8F468AF82D0D), and [server](../../js-implementation/c-variables/page-variables.md#concept_BF77952603BA454BAFC9A0A81D06A7D2).) 
...
* Increasing the wait time collects more DFA data, but also increases the risk of losing [!DNL Analytics] hit data.

  Losing [!DNL Analytics] hit data would occur when the user navigates away from the page during the *`s.maxDelay`* period. 

* Decreasing the wait time will lower the risk of losing [!DNL Analytics] hit data, but can reduce the amount of DFA data sent with hit data.
...
See [Mobile Tracking over WAP and I-Mode Protocols](adobe_mobile_tracking.md#concept_3E5C3405DEC74F59855A97FA3CE7EC3F). 
...
In rare cases, the URL of the page is not the URL that you would like reported in [!DNL Analytics]. 
...
|  Events  | Currency events associated with the specified product. See [Product-Specific Currency Events](../../js-implementation/c-variables/page-variables.md#section_F814DF053C0D463A97DA039E6323720C) and [Order-Wide Currency Events](../../js-implementation/c-variables/page-variables.md#section_D06F76A8A1F8498EB1BD6D8C8B9D5BE0).  |
|  eVars  | Merchandising eVar values associated with a specific product. See [Merchandising Variables](../../js-implementation/c-merch-variables/var-merchandising.md#concept_8B05F9352B354536999CE390E714F86B).  |
...
See [Merchandising Variables](../../js-implementation/c-merch-variables/var-merchandising.md#concept_8B05F9352B354536999CE390E714F86B).
...
If *`visitorNamespace`* is used in your JavaScript file, do not delete or alter it. If *`visitorNamespace`* changes, all visitors reported in [!DNL Analytics] may become new visitors. Visitor history becomes disconnected from current and future traffic. Do not alter this variable without approval from an Adobe representative. 

|  Max Size  | Debugger Parameter  | Reports Populated  | Default Value  |
|---|---|---|---|
|  N/A  | ns  | N/A  | ""  |

[!DNL Analytics] uses a cookie to uniquely identify visitors to your site. If *`visitorNamespace`* is not used, the cookie is associated 2o7.net. If *`visitorNamespace`* is used, the cookie is associated with a sub-domain of 2o7.net. All visitors to your site should have their cookies associated with the same domain or sub-domain.
