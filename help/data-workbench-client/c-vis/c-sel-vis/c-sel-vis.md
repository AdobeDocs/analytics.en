...
uuid: 99266f7a-e3f6-4415-bb0c-84aad9844d5e
index: y
internal: n
snippet: y
---
...
As shown in the example above, when a selection is made, a glow appears around the visualization and the non-selected elements within that visualization dim. To facilitate comparisons with the complete dataset, narrow white lines referred to as benchmarks appear in the bar graph to mark the shape of the original, unfiltered data. For more information about benchmarks, see [Understanding Benchmarks](../../../data-workbench-client/c-vis/c-ustd-benchmks.md#concept_C7B0F4102E92458096F8C4765CBE2914).
