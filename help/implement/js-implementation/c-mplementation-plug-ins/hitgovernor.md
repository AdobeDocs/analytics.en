...
title: hitGovernor
uuid: baf55e59-8b2b-4867-a067-e67a17d58a09
index: y
internal: n
snippet: y
---
...
The plugin increments a cookie value each time an image request is sent to your tracking servers, and tracks this over a rolling time frame. The default time frame is one minute, although that time frame can be overridden. (See [Implementation](../../js-implementation/c-mplementation-plug-ins/hitgovernor.md#task_D4BDB524AA294C139AFCAE2B61FEA3F2), below.) If the total number of hits during that time frame exceeds the default hit threshold (60), a final custom link image request is sent to set the *`exceptionFlag`* context data variable. The default hit threshold can also be overridden.
...
<b> s.governor();</b> 
   ...
   Below the doPlugins section of your AppMeasurement file, include the plugin code contained in [Plugin Source Code](../../js-implementation/c-mplementation-plug-ins/hitgovernor.md#reference_76423C81A7A342B2AC4BE41490B27DE0), below.
