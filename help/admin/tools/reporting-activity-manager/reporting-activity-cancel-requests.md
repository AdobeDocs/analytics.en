...
* You can cancel specific requests, cancel all requests from a specific user, or cancel all requests related to a specific project.
  ...
  When you cancel a request, the action is recorded in the [Logs](/help/admin/tools/logs.md). The [!UICONTROL **Event Type**] column displays as [!UICONTROL **Admin Action**], and a description of the cancellation is available in the [!UICONTROL **Event**] column.

* When you cancel requests, you can also choose to restrict subsequent requests for a given time period.

  When you restrict a subsequent request, the action is recorded in the [Logs](/help/admin/tools/logs.md). The [!UICONTROL **Event Type**] column displays as [!UICONTROL **Admin Action**], and a description of the restriction is available in the [!UICONTROL **Event**] column.
...
1. Select the report suite where you want to cancel reporting requests. <!--double-check this step-->
   ...
   For more information about the data available on this page, see [View reporting activity in the Reporting Activity Manager](/help/admin/tools/reporting-activity-manager/reporting-activity.md).
