...
Adobe computes this dimension server-side from the sequence of hits in each visit. There is no variable to set; it works out of the box for all implementations.
