...
uuid: 8465f273-2110-43ea-abbf-9ace3c71dddc
index: y
internal: n
snippet: y
---
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Common ways to implement Analytics include: </p> <p> 
     <ul id="ul_A7475867861540EFBD77AEE8C6DAD418"> 
      ...
      <li id="li_996FA2F5B0E149399CED391AB5235D8A"> <a href="../c-implement-with-dtm/c-implement-with-dtm.md#concept_90C125C03E024A9A9A1D7F47B3CCF4B5" format="dita" scope="local"> Dynamic Tag Management </a> <p>This guide contains Analytics-specific information to guide you through a Dynamic Tag Management implementation. </p> </li> 
      <li id="li_18E6AD6D864246D0BA26DAA1D91DD811"> <a href="../js-implementation/js-implementation.md#concept_CE78750AC2A4487D8ACD9369B3EAC85A" format="dita" scope="local"> JavaScript </a> <p>This guide contains a description of data collection variables and details on implementing data collection code in JavaScript, including <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/video/?f=video_js" format="https" scope="external"> video </a>. </p> </li> 
...
&nbsp;==============&nbsp;DO&nbsp;NOT&nbsp;ALTER&nbsp;ANYTHING&nbsp;BELOW&nbsp;THIS&nbsp;LINE&nbsp;!&nbsp;============
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="../impl-testing/impl-testing.md#concept_DCDA662572AC484D89333530F53FAA52" format="dita" scope="local"> Testing and Validation </a> Provides information about validating your implementation. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Install the <a href="https://chrome.google.com/webstore/detail/adobe-experience-cloud-de/ocdmogmohccmeicdhlhhgepeaijenapj" format="dita" scope="local"> Adobe Debugger </a>. After it is installed, load a page where you have deployed page code and then open the debugger. The debugger displays details about the collection data that was sent. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
For information about the differences between Launch, Dynamic Tag Management and JavaScript methods, see [Choose an Implementation Method](../c-implementation-methods/choose-implementation-method.md#concept_97CE27B16410422EB28B4B9CE3B9529B).
