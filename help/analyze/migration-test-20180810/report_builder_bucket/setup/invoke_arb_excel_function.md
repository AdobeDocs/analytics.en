...
uuid: 33a63f61-56a9-45f8-bb6b-613eefd37263
index: y
internal: n
snippet: y
translate: y
...
1. Right-click the control and select ** [!UICONTROL  Format Control] **. ![](Graphics/format_control.png) 

1. Click the [!UICONTROL  Alt Text] tab. ![](Graphics/alt_text.png) 
