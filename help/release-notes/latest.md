...
| ----------- | ---------- | ------- | ---- |
| **Scheduling in the new Report Builder** | Scheduling not only allows you to schedule your new Report Builder workbooks. In addition, it lets you retrieve the metadata on old scheduled tasks when you convert legacy workbooks. This way, when you convert your legacy workbooks to new workbooks and schedule them, you are sending them to the same emails and on the same cadence as the legacy workbooks. [Learn more]() |  |  January 22, 2025 |
