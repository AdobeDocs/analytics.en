...
uuid: 778b3968-1be8-4f24-ad49-ed5ade148f38
index: y
internal: n
snippet: y
---
...
* The [!UICONTROL getQueryParam] plug-in, used in the JavaScript file, retrieves a query string parameter from the URL. For more information on the [!UICONTROL getQueryParam] plugin, see [Implementation Plug-ins](../../js_implementation/c_mplementation_plug-ins/impl_plugins.md#concept_021F5E4A6BD745AE91E85E7138BE930F). 
...
* To keep click-throughs from being inflated, use the [!UICONTROL getValOnce] plugin to let the click-through for a campaign be counted only once per session. For more information on the [!UICONTROL getValOnce] plug-in, see [Implementation Plug-ins](../../js_implementation/c_mplementation_plug-ins/impl_plugins.md#concept_021F5E4A6BD745AE91E85E7138BE930F). 
...
|  Max Size  | Debugger Parameter  | Reports Populated  | Default Value  |
|---|---|---|---|
|  255 Bytes  | V1-v75 ( [or v100 or v250](../../js_implementation/c_variables/page-variables.md#concept_558663F3B8164986AB5D94128FEA7B28))  | Custom Conversion  | ""  |
...
While eVars may be renamed, they should always be referred to in the JavaScript file by eVarX, where X is a number between 1 and 75 ( [or 100, or 250](../../js_implementation/c_variables/page-variables.md#concept_558663F3B8164986AB5D94128FEA7B28)).
...
See [Event Serialization](../../js_implementation/event_serialization.md#concept_092B638D7FEE423D91F8A57EA8E09705) for more information.
...
* List props are enabled only on traffic variables ( [props](../../js_implementation/c_variables/page-variables.md#concept_0F10FA2DE69B4029A31EA5E9313AA254)). 
...
* Any custom traffic variable can become a list prop. (Exceptions: [pageName](../../js_implementation/c_variables/page-variables.md#concept_5827B499DAC34B5D8445F9D9140CC328), [channel](../../js_implementation/c_variables/page-variables.md#concept_C7770B8C15724A99B10F8F468AF82D0D), and [server](../../js_implementation/c_variables/page-variables.md#concept_BF77952603BA454BAFC9A0A81D06A7D2).) 
...
|  Events  | Currency events associated with the specified product. See [Product-Specific Currency Events](../../js_implementation/c_variables/page-variables.md#section_F814DF053C0D463A97DA039E6323720C) and [Order-Wide Currency Events](../../js_implementation/c_variables/page-variables.md#section_D06F76A8A1F8498EB1BD6D8C8B9D5BE0).  |
|  eVars  | Merchandising eVar values associated with a specific product. See [Merchandising Variables](../../js_implementation/c_merch_variables/var_merchandising.md#concept_8B05F9352B354536999CE390E714F86B).  |
...
See [Merchandising Variables](../../js_implementation/c_merch_variables/var_merchandising.md#concept_8B05F9352B354536999CE390E714F86B).
