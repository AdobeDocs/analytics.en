...
| **Activity Map extension: Web SDK support and UI refresh** <br/>Web SDK implmentations of Adobe Analytics can now use the Activity Map overlay extension to view click data overlaid on their websites.<p>Previously, the Activity Map overlay extension was available only for AppMeasurement implementations.</p> <p>In addition to Web SDK support, the Activity Map overlay extension also includes an updated look and feel.</p><p>(Documentation link to follow.)</p> | | End of July, 2026 |
