...
| **May 2022** | |
| Populate Lifecycle dimensions and metrics through Experience Edge | Mobile Lifecycle data sent via Experience Edge now appears in Analytics reporting. See [Analytics variable mapping](/help/implement/aep-edge/xdm-var-mapping.md) for details on which XDM fields map to existing mobile Lifecycle reporting. |
| **April 2022** | |
