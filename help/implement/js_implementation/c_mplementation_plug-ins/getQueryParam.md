...
uuid: dcf2ef0f-3dba-40ad-8d3e-dc27f61a5cc5
index: y
internal: n
snippet: y
---
...
>[!IMPORTANT]
>
>This plug-in is used by H code only. [AppMeasurement for JavaScript](../../js_implementation/c_appmeasurement_js/appmeasure_mjs.md#concept_F3957D7093A94216BD79F35CFC1557E8) provides this functionality natively using [Util.getQueryParam](../../js_implementation/util_getqueryparam.md#concept_763AD2621BB44A3990204BE72D3C9FA5).
...
In this example, if the user arrived at a landing page on your site where the URL was [!DNL http://www.yoursite.com/index.html?cid=123456], then *`s.campaign`* would receive a value of *123456*. This could be seen using the [!DNL DigitalPulse] Debugger, which should show *v0=123456* as part of the image request.
