...
* Create one or more channels so that you can assign rules to them. See [Add marketing channels](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/marketing-channels/c-channels.md).
