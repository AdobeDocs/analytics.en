...
uuid: d90d76f2-46a0-468d-8438-787ac62377bf
index: y
internal: n
snippet: y
---
...
>[!IMPORTANT]
>
>This example uses the visitor ID service, which is deployed as part of your [JavaScript Implementation](../js_implementation/js_implementation.md#concept_CE78750AC2A4487D8ACD9369B3EAC85A). Enabling the visitor ID service in AppMeasurement before you have included the Visitor API JavaScript file on all site pages could result in duplicate visitor counts. To avoid duplicate visitor counts, make sure that you understand and follow the process described in [Visitor ID Service](../js_implementation/c_unique_visitors/visid_service.md#concept_230F8759826E47789EA8DEE08FA09B07).
...
Make sure that you have also included a reference to `AppMeasurement.js` and `VisitorAPI.js` on each page. See [JavaScript Implementation](../js_implementation/js_implementation.md#concept_CE78750AC2A4487D8ACD9369B3EAC85A) for instructions. 
