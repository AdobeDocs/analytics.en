...
| **February 2021** | |
| February 4, 2021 | Component Selection: The drop-down/drop zone component found in [!UICONTROL Quick Insights] will be added to all drop zones in [!UICONTROL Workspace]. This enhancement allows you to pick from a drop-down list of compatible components or continue to use the space as a drop zone. |
| **January 2021** | |
