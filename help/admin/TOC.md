...
+ Data Collection {#data-collection}
    ...
    + Regional Data Collection {#rdc}
        +[Regional Data Collection overview](data-collection/rdc/regional-data-collection.md)
        +[Regional Data Collection for China](data-collection/rdc/rdc-china.md)
        +[Determine if you are using first- or third-party cookies](data-collection/rdc/determine-cookies.md)
        +[RDC environment characteristics](data-collection/rdc/rdc-environment-characteristics.md)
        +[Contact and legal information](data-collection/rdc/contact-legal-info.md)
