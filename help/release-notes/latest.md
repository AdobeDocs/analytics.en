...
| ----------- | ---------- | ------- | ---- |
| **Configure cloud account storage locations for ingesting classification data** | You can now manage cloud account storage locations that are used for classification set automation.<p>| N/A |July 10, 2023 |
