...
1. (Optional) You can also go to other Analytics component builders and ensure that they now show a report suite label indicating
    ...
    * Where a calculated metric will be created: [Calculated metric builder](/help/components/c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-build-metrics.md).
    * Where an alert will be built: [Alert builder](/help/components/c-alerts/alert-builder.md).
