...
1. **Familiarize yourself with Data Privacy labels, Adobe Analytics IDs, and namespaces.** See [Data Privacy Labels for Analytics Variables](/help/admin/admin/c-data-governance/data-labeling/gdpr-labels.md) and [Labeling Best Practices](/help/admin/admin/c-data-governance/data-labeling/gdpr-analytics-ids.md).
