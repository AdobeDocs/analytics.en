...
uuid: 3cc80117-b977-42b3-93fd-3accd89feb95
index: y
internal: n
snippet: y
---
...
Dynamic variables are passed by setting a variable to the desired value and then setting other variables to `D=[variable abbreviation]`. For abbreviations for each variable, see [Data Collection Query Parameters](../../../implement/js-implementation/data-collection/data-collection.md#concept_2F280ECF4205465FA9B5D773046C1A15). Dynamic variables can pull data from the following locations:
