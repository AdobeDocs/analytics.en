...
uuid: c78240ac-9b9e-4c3f-8bc3-2c6c4af5671f
index: y
internal: n
snippet: y
---
...
The [!UICONTROL Request Manager] displays when you click **[!UICONTROL Manage]** ( ![](assets/edit_request.gif)

) in the report builder Toolbar.
...
<table id="table_0880204181074BDBBA37E3DF2972A672"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Displays the Request Wizard dialog. See <a href="../../report_builder/data_requests/t_create_a_data_request.md#task_65B453C8F015429A8EA73A1B64025B6C" type="task" format="dita" scope="local"> Create a Data Request</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Edit </p> </td> 
   <td colname="col2"> <p> (Or Edit Multiple) Edits a selected request. The system displays the <span class="wintitle"> Request Wizard</span> dialog. See <a href="../../report_builder/manage_requests/t_edit_multiple_requests.md#task_70A13DBE43CD4BBEBE1B62459ADB3AD1" type="task" format="dita" scope="local"> Edit Multiple Requests</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Refreshes a single request or a selection of requests. (See <a href="../../report_builder/manage_requests/t_refresh_a_request.md#task_96556DB051A2479A955999D3837EE609" type="task" format="dita" scope="local"> Refresh a Request</a>.) </p> </td> 
  </tr> 
  <tr> 
