...
| Data center capacity | The  amount of reporting capacity you and other customers share within a data center. | The number of concurrent queries made by your organization and other organizations within your data center. | Adobe will optimize if space allows. Your organization is entitled to a set capacity and if the system is under a light load, Adobe will shift more capacity to you, above & beyond your entitled allowance. |
