...
uuid: e6a645e5-98ba-41e2-894f-b8fb5063f193
index: y
internal: n
snippet: y
---
...
For more information, see [Creating and Editing Derived Metrics](../c_admin_intrf/c_prof_mgr/c_drvd_mtrcs.md#concept_E41723B342A849309874B26232224A40). Metric expressions also can be used in worksheets. For more information, see [Worksheets](../c_analysis_vis/c_wksts/c_wksts.md#concept_45B50AAFC4D84709841F14AEE8022581). The following syntax is used to define metric expressions.
...
<table id="table_A6CA9C9F396448209398AA2A369E63FA"> 
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>An identifier references a named metric. For the rules governing legal identifiers, see <a href="../c_qry_lang_syntx/c_syntx_id.md#concept_735FA36FC49643269B3646AAAA8F2FA8" format="dita" scope="local"> Syntax for Identifiers </a>. </p> <p>Example: Revenue = Total_Price </p> </td> 
  </tr> 
  <tr valign="top"> 
