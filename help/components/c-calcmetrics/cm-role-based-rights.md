...
<table id="table_13F72FD90C964B86BD4B51E6F51ED292"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> Admins can create calculated metrics as well as create <a href="https://docs.adobe.com/content/help/en/analytics/admin/user-product-management/user-groups/groups.html"  > groups </a> to limit the rights of users to create calculated metrics. </td> 
