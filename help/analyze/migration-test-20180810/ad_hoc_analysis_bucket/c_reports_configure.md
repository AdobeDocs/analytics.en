...
uuid: 42533bfc-55b9-450a-b663-0c00c785047a
index: y
internal: n
snippet: y
translate: y
...
## Report Actions {#concept_26C41C0141A94B19B61D43955A908480}Actions that you can perform on a report, such as copying, saving, printing, renaming, and configuring delivery options.
<!-- c_report_actions.xml -->
In a report, click the ** [!UICONTROL  Report Actions] ** drop-down.  ![](graphics/tools_icon.png) 
...
<table id="table_C18A0F1C9E214EB585A29801BA2400F8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> See <a href="c_schedule.xml#reference_CA49AC560258471AAE959BCA243F170C" type="reference" format="dita" scope="local"> Delivery Options</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>See <a href="c_global_settings.xml#reference_EADAF83466994F89BCC6B0F49A9A53DB" type="reference" format="dita" scope="local"> General Settings Tab - Definitions</a>. </p> </td> 
  </tr> 
  <tr> 
...
>## Chart Options {#concept_9934CD0383AB4AA1A7B04C9F8AD30E6F}Options you can configure on a chart, such as changing the graph type, colors, and number of lines. Chart options differ depending on the type of graph you select.
<!-- c_chart_options.xml -->
...
<table id="table_99EBE6BB52B84611A3E8CD94540F59A4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>For <a href="c_reports_configure.xml#concept_07E26CC767B247A5845ADFF0C18B0986" format="dita" scope="local"> bubble charts</a>. Displays a statistical approximation of your data. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>
>1. At the report level, click ** [!UICONTROL  Settings] ** ![](graphics/settings_icon.png), then click ** [!UICONTROL  Copy Report Data] **.
...
>1. Click the [!UICONTROL  Trend] icon.  ![](graphics/TrendInspector_Buttcon.png)
...
>[!MORE_LIKE_THIS]* [ Table Builder ](c_tablebuilder.md#concept_664FC77306E148DBA4EA081814943C5E)## Custom Reports {#concept_039A45AAEEDC4828B3CDA080717B8E4F}Administrators can configure a report with specific metrics and a specific date range, and then save it to the report menus for everyone to use.
