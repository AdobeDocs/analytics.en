...
| Reports & Analytics Dashboard Image Reportlet | Grants access to Dashboard Reportlets. |
| Reports & Analytics Dashboard Metric Gauge Reportlet | Grants access to Dashboard Reportlets. |
| Reports & Analytics Dashboard Report Suite Summary Reportlet | Grants access to Dashboard Reportlets. |
| Reports & Analytics DashboardText Reportlet | Grants access to Dashboard Reportlets. |
| Reports & Analytics Dashboard Report Suite Summary Reportlet | Grants access to Dashboard Reportlets. |
| Reports & Analytics Dashboard External Reportlet | Grants access to Dashboard Reportlets. |
