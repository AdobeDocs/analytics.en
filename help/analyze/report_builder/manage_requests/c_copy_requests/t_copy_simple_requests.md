...
uuid: 70edf702-6356-4369-9e0e-620821390b4d
index: y
internal: n
snippet: y
---
...
Copy a simple request rather than a referential request. A simple request is one that contains no references to another request or the contents of a cell.
 ...
 A [referential request](../../../report_builder/manage_requests/c_copy_requests/t_copy_referential_requests.md#task_82A145CC2A774F5EA86977D670E07DC8) uses values from cells as input for parameters, such as a data filter or relational filter. These filters use either matching or trending and are based on results of a prior request or on the user-entered contents of a cell, called an input cell . 
