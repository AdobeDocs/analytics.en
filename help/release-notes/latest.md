...
| **Adobe Analytics 2.0 API Report suite creation** | Create report suites in Adobe Analytics with the 2.0 APIs. The new POST method replaces the 1.4 report suite API creation in preparation for the upcoming deprecation of the 1.4 APIs. | | October 2025 |
