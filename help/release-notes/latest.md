...
| ----------- | ---------- | ------- | ---- |
| **Configure cloud account storage locations for ingesting classification data** | You can now manage cloud account storage locations that are used for classification set automation.<p>[Learn more](/help/components/locations/configure-import-accounts.md)</p>|  |July 10, 2023 |
