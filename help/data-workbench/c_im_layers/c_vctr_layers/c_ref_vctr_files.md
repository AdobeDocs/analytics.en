...
uuid: 812396a5-e17a-4e12-a720-29ccf4cc4e47
index: y
internal: n
snippet: y
---
...
* **A layer file** that specifies the location of the [!DNL .vec] files. For more information about the required format of the layer file, see [Vector Layer File Format](../../c_im_layers/c_vctr_layers/c_ref_vctr_files.md#section_83A0077CF0C8479B9E7B2939BC761AF1).
