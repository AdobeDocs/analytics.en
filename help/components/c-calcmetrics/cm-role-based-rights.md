...
<table id="table_13F72FD90C964B86BD4B51E6F51ED292"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> Admins can create calculated metrics as well as create Product Profiles in the Admin Console to limit the rights of users to create calculated metrics. </td> 
