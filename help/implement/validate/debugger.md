---
title: Legacy Adobe CX Enterprise Debugger
description: Install the Legacy Adobe CX Enterprise Debugger. This debugger inspects tags for Analytics, Target, Advertising, Identity Service, and Data Collection tags.
...
---
# Legacy Adobe CX Enterprise Debugger
...
3. In the Name field, label it "Adobe CX Enterprise Debugger", and paste the code snippet into the URL field.
...
3. In the Name field, label it "Adobe CX Enterprise Debugger", and paste the code snippet into the Location field. The Tags and Keyword fields are not required.
...
2. Name the bookmark "Adobe CX Enterprise Debugger", and save it in the desired location.
...
* **Displayed CX Enterprise products:** Shows or hides image requests for each respective CX Enterprise product.
