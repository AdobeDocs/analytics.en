...
| Date|Description |
|---|---|
|January 22, 2020| Updated page on Freeform Table that include the new [Freeform Table Builder](/help/analyze/analysis-workspace/visualizations/freeform-table.md)|
