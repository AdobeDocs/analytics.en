...
To ensure uninterrupted reception of data, follow the steps in [Prepare to rotate account secrets](#prepare-to-rotate-location-account-secrets) prior to changing any account secrets. 
...
* **Location account secret**: The current account secret for the account.
