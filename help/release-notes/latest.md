...
| ----------- | ---------- | ---------- |
| **Cross-Device Analytics (CDA) entitlement** | April 13, 2022 | Effective **May 1, 2022**, any new implementation of [CDA](/help/components/cda/overview.md) will be limited to a maximum of three report suite IDs (RSIDs) per customer. |
