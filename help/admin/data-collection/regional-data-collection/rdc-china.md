...
>[!IMPORTANT]
>
>There is an additional cost associated with use of the China RDC node. Before implementing data collection in China using the RDC node described in this document, please contact your Adobe  product specialist or account team to ensure that you are correctly entitled to this functionality.
