...
| Analytics segmentation | Lets you build, manage, share, and apply powerful, focused audience segments to your reports using Analytics capabilities, Adobe CX Enterprise, Adobe Target, and other integrated Adobe products. | [Analytics segmentation](/help/components/segmentation/seg-home.md) |
