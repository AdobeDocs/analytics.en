...
| [!UICONTROL Admin Tools UI Access] | Not used |
...
| [!UICONTROL Company Settings UI Access] | Not used |
| [!UICONTROL Component migration] | Grants access to Admin > All admin > Component migration. |
| [!UICONTROL Current Data] | Not used |
| [!UICONTROL Data Governance & Privacy Labeling UI Access] | Grants access to Admin > Data Governance Privacy labeling. |
...
| [!UICONTROL Labs Access] | Gives users access to Labs and the prototypes within Labs. |
| [!UICONTROL Legacy Report Builder] | Allows the user to authenticate with the Legacy Report Builder add-on in Microsoft Excel. |
...
| [!UICONTROL MCP Access] | Grants access to use the [Adobe Analytics MCP server](https://developer.adobe.com/analytics-mcp/docs/aa/). This permission item is required for all users, including product admins, in order to use this tool. |
...
| [!UICONTROL Report Suites Admin UI Access] | Grants access to Admin > Report suites, but does not allow access to edit any settings or create report suites. Use [Report suite tools](report-suite-tools.md) permission items to selectively allow users to edit report suite settings. |
| [!UICONTROL Reporting Activity Manager UI Access] | Grants access to Admin > Reporting Activity Manager. |
