...
title: Plan segments
topic: Segments
uuid: 67ecd6a6-e79a-42ff-bea6-d9d3dd0f41ea
index: y
internal: n
snippet: y
---
...
1. Determine the segment **scope**. Which [segment container](../../c_segmentation/seg_overview.md#concept_82653C7E29FE49F5A4B5E5E93B0A6399) best represents the scope? Use the smallest container possible. 

1. Decide which **elements** to include in the segment definition, and which values. Consider [variable persistence](../../c_segmentation/seg_overview.md#concept_E579D72B1C644AE9A4C4EAF6B47A4DCB) in this decision. 
...
1. Define your segments with view to a** segment library** that gives business users the ability to [stack](../../c_segmentation/c_segmentation_workflow/seg_build.md#concept_40C299B60B354E10B344702EA3138B34) and reuse segment pieces or components in a modular fashion. What "modules" do you need to define to make this library a reality?
