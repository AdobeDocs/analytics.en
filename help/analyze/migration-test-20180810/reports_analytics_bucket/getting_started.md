...
uuid: 6ff91409-d640-4261-88d7-d650a65d4f88
index: y
internal: n
snippet: y
translate: y
...
## Getting Started with Reports and Analytics {#concept_8C531D94965743BFBED7A87FE5473FF0}Before using Reports and Analytics, understand these basic login and setup tasks, and how to access account information.For advanced users and administrators familiar with the interface, the [ Analytics Help Reference ](https://marketing.adobe.com/resources/help/en_US/reference/index.html) is available. 
>## Browser and System Requirements {#concept_7E987A1E578940B1859D89CA14FAFF34}Browser and system requirements to log in to the Reports &amp; Analytics interface.
<!-- requirements.xml -->
...
>## Logging In to Reports and Analytics {#concept_27B0A630D26D497E98F6A4AFA579BA9A}Learn how to log in using a standard login or through single sign-on.
<!-- login.xml -->
Before accessing the interface, work with your Account Manager or Customer Care to set up your company's account. 
>## Logging In Using a Standard Login {#task_82DC2BD377C24E7EABF4A09493A941E8}Steps that describe how to log in.
<!-- t_login_standard.xml -->
After logging in for the first time, change your password. For more information, see [ Editing an User Account ](getting_started.md#topic_0028683CA91A4526BE987363F8005A60). 
...
>## Logging In Using Single Sign-On {#task_BDC7532F7CBF4689A2079BB2CCD64F01}Steps that describe how to log in using single sign-on.
<!-- t_login_sso.xml -->
...
>       The Experience Cloud automatically logs you out after 30 minutes of inactivity. 
>## Run a report {#task_C6772791AFD642CFB9C51ADB9E5932A5}Steps that describe how to generate a report.
<!-- t_running_report.xml -->

>1. Log in to [!UICONTROL  Reports &amp;amp; Analytics].
>   The Reports menu displays, or a [ dashboard ](dashboard.md#concept_8CD3ACA2830A4994A68A31D8773B57E0) displays, if you have set one up. 
>
>1. Click ** [!UICONTROL  Site Content] ** > ** [!UICONTROL  Pages] ** (for example).
>   ![](graphics/pages_report.png) 
>
>   See [ Report Features ](report_overview.md#concept_AEA3BBC8167040198E0FECEAB2E0A677) for information about interface features of a report. 
>
>## Edit a user's account settings {#concept_7FAF5B923B984426B7F64E026EA2DCAA}Information about editing user accounts, resetting user passwords, and editing contact information.
<!-- t_acct_info.xml -->
...
Click the Account icon  ![](graphics/account.png)at the top right, then click the ** [!UICONTROL  Account Settings] ** (wheel) icon next to your login name. 
...
>## Change the interface language {#task_E20F9C7713C444998C883CFF93DC848A}Steps that describe how to change the interface language. You can view the Reports and Analytics interface in the language of your choice.
