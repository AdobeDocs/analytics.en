...
>[!NOTE]
>
>This list is different than the default list of social networks in [Marketing channel processing rules](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/marketing-channels/c-rules.md).
