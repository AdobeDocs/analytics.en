...
| ----------- | ---------- | ---------- |
| **Update to device lookups due to Google Client Hints** | February 17, 2023 | **The use of client hints, planned for February 16, 2023, was postponed in order to better ensure the quality of device lookups using hints. We will communicate a new rollout date shortly.** [Learn more](/help/technotes/client-hints.md)|
