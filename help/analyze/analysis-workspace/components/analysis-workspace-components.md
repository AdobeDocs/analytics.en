...
You can make the date range components relative to the panel calendar. For additional information, see [About relative panel date ranges](/calendar-date-ranges/calendar.md#relative-panel-dates).
