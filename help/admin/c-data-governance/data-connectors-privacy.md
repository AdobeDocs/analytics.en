...
>[!NOTE]
>
>This information is provided to help you identify variables that must be [labeled](../../admin/c-data-governance/privacy-setup-reportsuite.md#concept_FAA948AD8CEA4BC38CB482EAF3648731), but it is your responsibility as the data controller to apply the appropriate labels or perform other actions for [Data Privacy readiness](../../admin/c-data-governance/an-privacy-overview.md#concept_767057B9F0624A06B3598E02856861D8) (updating classifications, etc.).
