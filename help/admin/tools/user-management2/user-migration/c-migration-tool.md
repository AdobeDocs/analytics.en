 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>These will remain available to you in Analytics user management. </p> <p>See <a href="/help/admin/tools/user-management2/user-migration/c-migration-tool.md"> Unsupported Analytics features in the Adobe Admin Console</a> for more information. </p> </td> 
  </tr> 
  <tr> 
