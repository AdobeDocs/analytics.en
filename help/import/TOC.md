...
+ appFigures Data Connector for Adobe Analytics {#appfigures}
   + [appFigures Data Connector for Adobe Analytics](data-connectors/appfigures-overview/appfigures-overview.md)
...
+ Aprimo Data Connector for Adobe Analytics {#aprimo}
   + [Aprimo Data Connector for Adobe Analytics](data-connectors/aprimo-overview/aprimo-overview.md)
      + [Key Benefits and Features](data-connectors/aprimo-overview/aprimo-benefits.md)
      + [Dynamic Marketing Segments](data-connectors/aprimo-overview/aprimo-marketing-segments.md)
      + [Before You Activate](data-connectors/aprimo-overview/aprimo-requirements/aprimo-requirements.md)
         + [Pricing](data-connectors/aprimo-overview/aprimo-requirements/aprimo-pricing.md)
         + [Adobe Analytics Variables](data-connectors/aprimo-overview/aprimo-requirements/aprimo-variables.md)
