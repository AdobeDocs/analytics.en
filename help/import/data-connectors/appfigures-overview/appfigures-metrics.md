...
<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Calculated Metric </th> 
   <th colname="col2" class="entry"> Description </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> App Store Average Rank (Numeric) </td> 
   <td colname="col2"> <p>The average app ranking. This calculated metric is defined using the following formula: </p> <code> [App&amp;nbsp;Store&amp;nbsp;Rank]&amp;nbsp;/&amp;nbsp;[App&amp;nbsp;Store&amp;nbsp;Rank&amp;nbsp;Divisor] </code> <p>Note:  The number of applications ranked per category and country varies between app stores. If your application is ranked lower than this threshold, application ranks are not available. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> App Store Average Rating </td> 
   <td colname="col2"> The average app rating. This calculated metric is defined using the following formula: <code> [App&amp;nbsp;Store&amp;nbsp;Rating]&amp;nbsp;/&amp;nbsp;[App&amp;nbsp;Store&amp;nbsp;Rating&amp;nbsp;Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col9"> App Store Revenue (one-off) </td> 
   <td colname="col10"> App Store Avg. Rank </td> 
   <td colname="col11"> App Store Avg. Rating </td> 
  </tr> 
  <tr> 
   <td> Country Name </td> 
