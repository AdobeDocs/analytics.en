...
Server Calls Usage Alerts are part of the [Alerts](/help/components/alerts/alert-manager.md) user interface.
...
1. Complete one or more of these actions: 
   ...
   | Action | Definition |
   |--- |--- |
   |+ Add|Access the [Alert Builder](/help/admin/tools/server-call-usage/scu-alerts.md) by clicking  [!UICONTROL + Add].|
   ...
   |Export to CSV|See [Download Usage Report](/help/admin/tools/server-call-usage/report-suite-usage.md)|
