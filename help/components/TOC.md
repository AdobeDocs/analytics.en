...
+ Calculated metrics {#calculated-metrics}
  ...
  + Calculated metrics workflow {#calcmetric-workflow}
    ...
    + [A simple calculated metric](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-pvv.md)
    + [A more complex calculated metric](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-orders-participation.md)
