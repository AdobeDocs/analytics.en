...
1. Now "map" this new data source to the custom events we created in [Success events](/help/admin/tools/manage-rs/edit-settings/conversion-var-admin/c-success-events/success-event.md).
