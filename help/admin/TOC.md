  ...
  + Report Suite manager {#manage-report-suites}
    ...
    + Edit settings of a report suite {#edit-report-suite}
      + General {#report-suite-general}
        + [General Account settings](admin/manage-report-suites/report-suite-general/general-acct-settings-admin.md)
        + [Internal URL Filters](admin/manage-report-suites/report-suite-general/internal-url-filter-admin.md)
        + [Customize calendar](admin/manage-report-suites/report-suite-general/custom-calendar.md)
        + Paid search detection {#paid-search-detection}
          + [Paid search detection overview](admin/manage-report-suites/report-suite-general/paid-search-detection/paid-search-detection.md)
          + [Configure paid search detection](admin/manage-report-suites/report-suite-general/paid-search-detection/t-paid-search-detection.md)
        + [Menu customizing](admin/manage-report-suites/report-suite-general/customize-menus.md)
        + Processing rules {#processing-rules}
          + [Processing rules overview](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules.md)
          + Processing rules configuration {#processing-rules-configuration}
            + [How processing rules work](admin/manage-report-suites/report-suite-general/c-processing-rules/c-processing-rules-configuration/processing-rules-about.md)
            + [Create processing rules](admin/manage-report-suites/report-suite-general/c-processing-rules/c-processing-rules-configuration/t-processing-rules.md)
            ...
            + [View processing rule history](admin/manage-report-suites/report-suite-general/c-processing-rules/c-processing-rules-configuration/t-processing-rule-view-history.md)
            ...
            + [Dimensions available to processing rules](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rule-dimensions.md)
          + Processing rules examples {#processing-rules-examples}
            + [Examples of processing rules](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-examples.md)
            + [Populate a campaign ID from a query string parameter](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-populate-campaign-id.md)
            + [Set the product view event from the product overview page](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/setting-the-product-view-event.md)
            + [Add a subcategory by concatenating the category and page name](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/subcategory-concatenating.md)
            + [Determine a path by copying an eVar value to a prop](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-determining-path.md)
            + [Clean up values in a report](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/clean-up-values-in-a-report.md)
            + [Populate internal search terms using a query string parameter](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-populating-internal-search.md)
            + [Copy a context data variable to an eVar](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data.md)
            + [Set an event using a context data variable](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data-event.md)
            + [Remove an event from a hit](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-examples/processing-rules-remove-event.md)
          + [Processing rules tips and tricks](admin/manage-report-suites/report-suite-general/c-processing-rules/processing-rules-tips.md)
