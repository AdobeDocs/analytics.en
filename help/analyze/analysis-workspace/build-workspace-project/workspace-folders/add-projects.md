...
1. Select ![FolderAddTo](/help/assets/icons/FolderAddTo.svg) **Move to** from the list of possible [actions](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md#actions). The **[!UICONTROL Select Folder]** dialog is displayed.
...
1. Select ![ProjectAdd](/help/assets/icons/ProjectAdd.svg) **Add Projects** from the list of possible [actions](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md#actions). The **[!UICONTROL Select Folder]** dialog is displayed.
