...
| Calculated metrics-based segment | [Calculated metric builder](/help/components/calculated-metrics/c-workflow/cm-workflow/c-build-metrics/metrics-with-segments.md) | To individual calculated metric | Apply segment/s within your metric definition |
