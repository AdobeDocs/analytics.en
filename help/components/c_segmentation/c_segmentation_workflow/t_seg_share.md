...
topic: Segments
uuid: 3ccee250-105a-427b-abbf-ddc486fc0c40
index: y
internal: n
snippet: y
---
...
* As an Admin, share a segment with **[!UICONTROL All]** if it's of use to the entire company and everyone is comfortable using it. In this case, you should also consider making it an [approved](../../c_segmentation/c_segmentation_workflow/seg_approve.md#concept_DF477F151A9E483A92ED1DDAAF035953) segment. 
