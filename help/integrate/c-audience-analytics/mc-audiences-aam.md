...
uuid: 96bb741f-7f02-4a35-b857-372613cfaf8e
index: y
internal: n
snippet: y
---
...
1. With [server-side forwarding](../../integrate/c-audience-analytics/c-workflow/ssf.md#concept_9563FCADF29748928E770EC5221B2685), each hit that Analytics receives is automatically sent to AAM in real time. 
...
* You use [server-side forwarding](../../integrate/c-audience-analytics/c-workflow/ssf.md#concept_9563FCADF29748928E770EC5221B2685) and have implemented the [Audience Management module](https://marketing.adobe.com/resources/help/en_US/aam/c_profiles_audiences.html) (no DIL code) - AppMeasurement 1.5 or later.
