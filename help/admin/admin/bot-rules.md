...
title: Bot Rules
topic: Admin tools
uuid: 6f90c914-2320-4699-ba49-9bf29f1a1517
index: y
internal: n
snippet: y
---
...
VISTA rules are applied after Bot Rules (see [Processing Order](../admin/c-processing-rules/c-processing-rules-configuration/processing-rule-order.md#concept_8A6BBEA7F50C40C8A8D8755D4F579B1E)).
