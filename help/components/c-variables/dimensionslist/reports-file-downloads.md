...
1. In the file, locate the [s.trackDownloadLinks](http://marketing.adobe.com/resources/help/en_US/sc/implement/index.html?f=c_trackdownllinks) variable. Ensure that it is set to *true* 

1. Locate the [s.linkDownloadFileTypes](http://marketing.adobe.com/resources/help/en_US/sc/implement/index.html?f=c_linkdownfiletypes) variable. Ensure that all of the desired file extensions are present in this list. If necessary, add missing extensions like [!DNL .zip], [!DNL .pdf], and so on.)
