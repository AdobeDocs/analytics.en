...
| **Hands-on tutorial for Analysis Workspace**<br/>A new hands-on tutorial is now available to guide new users through the basics of using panels, visualizations, and components in Analysis Workspace. <p>(Documentation link to follow.)<!--For more information, see "Learning paths" in "Customer Journey Analytics landing page".--></p>  | | Mid-March 2026 |
| **Activity Map 4.0** <br/>Activity Map 4.0 is now available. In addition to all Activity Map v3.0 functionality, Activity Map 4.0 includes the following enhancements:<ul><li>Support for the Activity Map Overlay extension with Web SDK implementations. (Previously, the overlay extension was not supported with Web SDK implementations of Adobe Analytics.)</li><li>New Spectrum based UI (some controls may have changed)</li><li>Support for WebSDK tracking (when the tracking goes to Analytics)</li></ul>| | March 2026 |
