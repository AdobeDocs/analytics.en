...
## Prerequisites
You must have AppMeasurement (i.e. the base Adobe Analytics Code) and the inList plugin (included in the Code to Deploy section below) to run the apl plugin
