...
seo-title: Virtual report suites - component curation
title: Virtual report suites - component curation
uuid: be89635e-e3f1-4402-9215-017cb53231e6
index: y
internal: n
snippet: y
---

# Virtual report suites - component curation
...
1. Select the checkbox **[!UICONTROL Enable Virtual Report Suite Component Customization]**:
