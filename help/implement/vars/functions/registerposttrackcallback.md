...
The `s.registerPostTrackCallback` is a function that takes a function as its only argument. The nested function run immediately after an image request is successfully sent.
