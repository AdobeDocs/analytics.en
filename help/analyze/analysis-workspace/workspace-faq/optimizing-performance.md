...
|`This dimension does not currently support non-default attribution models.`|We recommend replacing the dimension in your table with one that is compatible with [Attribution IQ](/help/analyze/analysis-workspace/c-panels/attribution/attribution.md).|
