...
+ Calculated metrics {#calculated-metrics}
  ...
  + Calculated metrics workflow {#calcmetric-workflow}
    ...
    + [Build a simple metric](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-pvv.md)
    + [Build a more complex metric](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-orders-participation.md)
