...
As the alert system for all of Adobe Analytics, Intelligent Alerts let you create and manage alerts, while also providing features for alert preview and rule contribution. You can
