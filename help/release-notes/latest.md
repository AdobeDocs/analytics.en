...
| **SFTP upgrade** | September 19, 2022 | Previously, Adobe had communicated that Adobe would upgrade its Secure File Transfer Protocol (SFTP) services in September 2022 to provide improved security for file transfer. Adobe has postponed this upgrade to **September 20, 2022**. When this change takes place, certain SFTP client configurations is no longer supported. This impacts only data sent to or retrieved from Adobe Analytics using SFTP. The FTP protocol is not impacted. In order to avoid service disruptions, please ensure that your SFTP clients (code, tools, services) are in accordance with the changes detailed [here](https://experienceleague.adobe.com/docs/analytics/export/ftp-and-sftp/secure-file-transfer-protocol/sftp-upgrade.html). |
