...
1. Configure the [!UICONTROL Display] options:
   ...
   |Data Recency|Displays data recency parameters. For example:    Data Recency: Page Views (1.5 hr ago), Exits (30 mins ago)  See [Options](/help/analyze/legacy-report-builder/options.md) for information about current data processing.|
   ...
   **Name this Request:** Lets you type a user-defined name for the request, or use the default name selected on Step 1. This name appears as the [!UICONTROL Report] name in the [!UICONTROL Request Manager]. See [Name a Request](/help/analyze/legacy-report-builder/layout/name-a-request.md).
