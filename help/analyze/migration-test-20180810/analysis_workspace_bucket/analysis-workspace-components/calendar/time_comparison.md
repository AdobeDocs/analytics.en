...
uuid: f0ae55d7-60da-41e7-a254-32a5385ccecc
index: y
internal: n
snippet: y
translate: y
...
1. Right-click a table row and select ** [!UICONTROL  Compare Time Periods] **. ![](graphics/compare-time.png) 
...
1. The resulting comparison looks like this: ![](graphics/compare-time-result.png) 

   Rows in the Percent Change column appear red for negative values and green for positive values. 

1. (Optional) As in any other Workspace projects, you can create visualizations based on these time comparisons. For example, here is a Bar graph: ![](graphics/compare-time-barchart.png) 
...
1. Right-click a column in the table and select ** [!UICONTROL  Add Time Period Column] ** ![](graphics/add-time-period-column.png) 
...
1. The time period will be inserted on top of the column you selected: ![](graphics/add-time-period-column2.png) 

1. You can add as many time columns as you want, as well as mix and match different date ranges: ![](graphics/add-time-period-column4.png) 
...
![](graphics/date-comparison-setting.png) 
...
![](graphics/add-time-period-column3.png) 
