...
1. If you have not already done so, [create a group](../../../admin/user-management2/c-user-groups/t-user-group.md) that includes only those non-admins that should have authorization to use processing rules.
1. [Add the non-administrator/s to that group](../../../admin/user-management2/c-user-management/t-add-user-to-group.md). 
