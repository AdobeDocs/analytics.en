...
* Create one or more channels so that you can assign rules to them. See [Add marketing channels](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-channels.md).
