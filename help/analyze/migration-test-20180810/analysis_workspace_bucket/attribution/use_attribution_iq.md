...
uuid: 3338f602-d3a4-40ce-ac7f-f7253e6467f3
index: y
internal: n
snippet: y
translate: y
...
* [ Use Attribution in Freeform Tables ](use_attribution_iq.md#section_F2F72AE840EB4EA781302A559726E6F4)
* [ Apply Attribution Models to Breakdowns ](use_attribution_iq.md#section_ED1E7532CF084B5AB0942BD80B4770C9)
* [ Compare one Attribution Model to Another ](use_attribution_iq.md#section_1D74C09549CC4EC8A952A7392C76D375)
* [ Attribution Panel and Visualizations ](use_attribution_iq.md#section_6B02F28182F14ECC9FC5020F224726E6)
...
1. Click the Settings (gear) icon in a Freeform Table column. ![](graphics/Column Settings.png) 

1. Under ** [!UICONTROL  Data Settings] **, check ** [!UICONTROL  Use non-default attribution model] **. For more information on the different attribution models, refer to [ Attribution IQ Overview ](attribution.md#section_4B9E7F83AE0B451A992397E55C3F5871). ![](graphics/Attribution Model Selection.png) 
...
![](graphics/breakdown_settings.png) 

## Compare one attribution model to another {#section_1D74C09549CC4EC8A952A7392C76D375}

If you’d like to quickly and easily compare one attribution model to another, right click a metric and select ** [!UICONTROL  Add comparative attribution model] **: 

![](graphics/Comparative Attribution Model.png) 
...
1. Drag the Attribution Panel into your Analysis Workspace Project. ![](graphics/Attribution Panel 1.png) 

1. Add a success metric that you want to attribute and add any channel dimension to attribute against (such as Marketing Channels or Internal Promotions). ![](graphics/attribution_panel2.png) 
