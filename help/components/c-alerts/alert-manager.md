...
The Alerts manager is structured like the [Segment manager](/help/components/segments/seg-manage.md) and the [Calculated metric manager](/help/components/c-calcmetrics/c-workflow/cm-workflow/cm-manager.md).
