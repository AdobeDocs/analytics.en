...
seo-title: Histogram
title: Histogram
uuid: 64736c41-d38d-420c-a683-170e8dfc4b95
index: y
internal: n
snippet: y
translate: y
...
A histogram is similar to a bar chart, but it groups numbers into ranges (buckets). Analytics automates the "bucketing" of numbers into ranges, but you can change the settings in [ Advanced Settings ](histogram.md#section_09D774C584864D4CA6B5672DC2927477). 
...
![](graphics/prebuilt_segments.png) 
