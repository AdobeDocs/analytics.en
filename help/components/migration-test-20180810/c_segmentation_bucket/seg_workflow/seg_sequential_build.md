...
topic: Segments
uuid: 1cea1ae8-d06c-4ca5-a1e2-8aad7cab8cc0
index: y
internal: n
snippet: y
translate: y
...
![](graphics/before-after-sequence.png) 

Additionally, you can constrain sequential segments to a&nbsp;specific duration of time, granularity, and counts between checkpoints using the [ After and Within operators ](seg_sequential_build.md#concept_07708877D06742998C6237DD9FD194EA). 
...
![](graphics/segment_sequential_1.png) 
...
![](graphics/visitor_seq_across_visits.png) 
...
![](graphics/mixed_level_checkpoints.png) 
...
![](graphics/aggregate_checkpoints2.png) 
...
![](graphics/nesting_sequential_seg.png) 
...
The [!UICONTROL  Exclude] operator can be employed to identify a sequence where specific visits or hits are not performed by the visitor. [!UICONTROL  Exclude Checkpoints] can also be included within a [ Logic Group ](seg_sequential_build.md#concept_23CE0E6071E14E51B494CD21A9799112) 

. 

<!-- seg_example_exclude_between_checkpoints.xml -->
...
![](graphics/exclude_between_checkpoints.png) 
...
![](graphics/exclude_beginning_sequence.png) 
...
![](graphics/exclude_end_sequence.png) 

<!-- seg_example_sequence_and.xml -->
Within a sequential segmentation, it is required that containers are ordered strictly within the [ container hierarchy ](seg_overview.md#concept_A38E7000056547399E346559D85E2551). The [!UICONTROL  Logic Group] container was designed to be used when higher level containers are required in sequential segments to further filter visitors and to furnish complex, nested, visitor-level constraints to refine the segment. 

|  Standard Container Hierarchy  |
|---|
|   ![](graphics/nesting_container.png)  | Within the [!UICONTROL  Visitor] container, the [!UICONTROL  Visit] and [!UICONTROL  Hit] containers are nested in sequence to extract segments based on hits, the number of visits, and the visitor.  |
...
1. Click the container icon and select ** [!UICONTROL  Logic Group] **.  ![](graphics/logic_group_checkpoints.png)
...
![](graphics/logic_group_any_order2.png) 
...
![](graphics/logic_group_1st_match.png) 
...
Build this segment by dragging Dimensions, Events, and pre-built Segments from the left panes. See [ Building a Logic Group Segment ](seg_sequential_build.md#concept_23CE0E6071E14E51B494CD21A9799112). 
...
![](graphics/logic_exclude_and.png) 
...
![](graphics/then_within_operators.png) 
...
<!-- seg_example_time_between_after.xml -->
...
![](graphics/time_between_after_operator.png) 
...
<!-- seg_example_time_between_within.xml -->
...
![](graphics/time_between_within_operator.png) 
...
<!-- seg_example_time_between_within_after.xml -->
...
![](graphics/time_between_using_both_operators.png) 
...
![](graphics/within_after_together.png) 

## Matches {#section_65923AB563864F18ABC9734130A8A7AA}

Any visitors hitting page A on June 1, 2013 are returning after June 15, 2013 00:01, but *before* July 1, 2013 are included in the segment. Compare with [ Time Between Exclusions ](seg_sequential_build.md#concept_C5CB0A391B7C4AC8A95B9724A14E28E8). 

The [!UICONTROL  After] and [!UICONTROL  Within] operators can be used together to define a sequential segment. 

![](graphics/time_between_within_after.png) 
