...
uuid: 8d7ee46e-081a-4491-a503-23ea514679f3
index: y
internal: n
snippet: y
---
...
* **Permissions**: Administrators can grant access to non-admins: the permission is called [!UICONTROL Server Call Usage]. See [Billing Permission](../../admin/c-server-call-usage/overage-overview.md#section_FCC58EB635954A32990D4E67B52B4369)
