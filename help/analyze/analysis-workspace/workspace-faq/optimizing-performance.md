...
|Factor|Defintion|Influenced by|Optimization|
|---|---|---|---|
...
| This dimension does not currently support non-default attribution models. | Non-default attribution is not supported for the dimension you are using. | Replace the dimension in your table with one that is compatible with [Attribution IQ](../attribution/overview.md).|
