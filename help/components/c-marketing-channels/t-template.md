...
seo-description: How to use a master report suite as a template for testing your marketing channel configuration. To save time, you can apply this template to one or more production report suites in a mass update. You perform this task for channels and rule sets separately.
seo-title: Apply template report suite settings to multiple report suites
solution: Analytics
subtopic: Marketing channels
title: Apply template report suite settings to multiple report suites
topic: Reports and analytics
uuid: 31d75361-4fd4-4e8f-9abd-7d75a8e8b5b6
index: y
internal: n
snippet: y
---
