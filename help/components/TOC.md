...
+ Calculated metrics {#calculated-metrics}
  ...
  + Workflow {#calcmetric-workflow}
    ...
    + [A simple example](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-pvv.md)
    + [A more complex example](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-orders-participation.md)
    + [Metric type and attribution](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/m-metric-type-alloc.md)
    + [Participation metrics](c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/participation-metric.md)
    ...
    + [Mark calculated metrics as favorite](c-calcmetrics/c-workflow/cm-workflow/cm-favorite.md)
  ...
  + Reference {#calcmetrics-reference}
    ...
    + [Role-based rights](c-calcmetrics/cm-role-based-rights.md)
