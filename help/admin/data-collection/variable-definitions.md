...
|[linkName](https://marketing.adobe.com/resources/help/en_US/sc/implement/linkName.html)|Optionally used to identify the name of a link when sending in custom, download, or exit link data.|[File Downloads Report](/help/components/c-variables/dimensionslist/reports-file-downloads.md)<br></br>[Custom Links Report](/help/components/c-variables/dimensionslist/reports-custom-links.md)<br></br>[Exit Links Report](/help/components/c-variables/dimensionslist/reports_exit_links.md)|
