...
1. Click **[!UICONTROL Site Content]** > **[!UICONTROL Pages]** (for example).
   ...
   See [Report Features](../../analyze/reports-analytics/overview-(2)/report-overview.md#concept_AEA3BBC8167040198E0FECEAB2E0A677) for information about interface features of a report. 
