...
seo-title: Install [!DNL Activity Map] browser plug-ins
solution: Analytics
title: Install [!DNL Activity Map] browser plug-ins
topic: Activity map
uuid: b5c07718-e25c-4ba9-885d-3a2a47dd9f60
---

# Install [!DNL Activity Map] browser plug-ins{#install-activity-map-browser-plug-ins}

The installation process varies depending on which browser you are using.

[!DNL Activity Map] browser plug-ins:
...
* **Can inject** the [!DNL Activity Map] toolbar on web pages that do not contain Analytics page code. Will show an error message if the page does not contain the Analytics page code.
...
1. [!DNL Activity Map] should be listed as one of the Firefox Add-ons.
1. If you see an Adobe Analytics icon  ![](assets/an_icon.png) added to your tool bar, your download was successful. You can now [launch [!DNL Activity Map]](/help/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-launch.md) from your page.
