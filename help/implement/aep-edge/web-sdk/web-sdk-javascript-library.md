...
* **Most direct approach**: This implementation path is the most straightforward and typically the recommended path for new Web SDK implementations. If you do not have a current Adobe Analytics implementation to worry about, then you have little need to use the `data` object with the Web SDK; you can simply populate the applicable Web SDK XDM fields.
