...
| **3<sup>rd</sup>** | `mid` | For AppMeasurement-based implementations (including the Analytics tag extension) using the [Visitor ID Service](https://experienceleague.adobe.com/en/docs/id-service/using/home), the visitor has an existing [`s_ecid`](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/cookies/analytics) or `AMCV` cookie. For Web SDK-based implementations, the visitor has an existing [`kndctr_<orgId>_identity`](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/cookies/web-sdk) or `AMCV` cookie. Adobe recommends using ECID as the primary form of visitor identification for all implementations where possible. |
