...
| ----------- | ---------- | ---------- |
| **New domain for system-generated emails** | July 13, 2022 | Adobe recently changed the sender's domain for emails from Workspace projects, alerts, and overage alerts, from `noreply@omniture.com` to `noreply@adobe.com`. Add this new email to your allow list if your organization allows only specific senders. |  
