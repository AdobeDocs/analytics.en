...
6. [**Marketing Channel processing rules**](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-rules.md): You can use [Processing rules](/help/admin/tools/manage-rs/edit-settings/general/processing-rules/pr-overview.md) to prepare data for use in Marketing Channel processing rules.
