...
title: hitGovernor
uuid: 8e868c1f-4f37-49e7-8245-397bea0cef7d
index: y
internal: n
snippet: y
---
...
The plugin increments a cookie value each time an image request is sent to your tracking servers, and tracks this over a rolling time frame. The default time frame is one minute, although that time frame can be overridden. (See [Implementation](../../js_implementation/c_mplementation_plug-ins/hitgovernor.md#task_D4BDB524AA294C139AFCAE2B61FEA3F2), below.) If the total number of hits during that time frame exceeds the default hit threshold (60), a final custom link image request is sent to set the *`exceptionFlag`* context data variable. The default hit threshold can also be overridden.
...
<b> s.governor();</b> 
   ...
   Below the doPlugins section of your AppMeasurement file, include the plugin code contained in [Plugin Source Code](../../js_implementation/c_mplementation_plug-ins/hitgovernor.md#reference_76423C81A7A342B2AC4BE41490B27DE0), below.
