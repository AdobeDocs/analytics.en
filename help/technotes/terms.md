...
* **Launch:** Short for Adobe Experience Platform Launch, Adobe's current implementation solution. See [Overview](https://experienceleague.adobe.com/docs/ launch/using/overview.html) in the Adobe Experience Platform Launch user guide.
