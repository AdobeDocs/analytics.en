...
Admins can filter the project list to display and manage company reports. Pinned items remain pinned followed by the list of company reports that are identified by the <name> icon. In this view, you can delete, rename, tag, or approve one or more reports.
