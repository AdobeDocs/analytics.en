...
| ----------- | ---------- | ---------- |
| **EOL for Data Workbench** | September 6, 2022 | Adobe intends to end of life Data Workbench effective **December 31, 2023**. Please contact your Adobe Customer Care representative for alternative solutions to Data Workbench or if you have any questions. |
| **SFTP upgrade** | September 6, 2022 | Previously, we had communicated that Adobe would upgrade its Secure File Transfer Protocol (SFTP) services in September 2022 to provide improved security for file transfer. We have postponed this upgrade to **TBD**. When this change takes place, certain SFTP client configurations will no longer be supported. This impacts only data sent to or retrieved from Adobe Analytics using SFTP. The FTP protocol is not impacted. In order to avoid service disruptions, please ensure that your SFTP clients (code, tools, services) are in accordance with the changes detailed [here](https://experienceleague.adobe.com/docs/analytics/export/ftp-and-sftp/secure-file-transfer-protocol/sftp-upgrade.html). |
