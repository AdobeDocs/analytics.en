...
This dimension is derived from the timestamp of each hit; there is no variable to set. As noted above, the hour reflects the report suite's time zone rather than the visitor's local time zone.
