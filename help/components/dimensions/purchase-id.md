---
title: Purchase ID
description: The unique identifier for a purchase, available in Data Warehouse.
feature: Dimensions
product_v2:
...
The 'Purchase ID' [dimension](overview.md) provides the unique identifier for a purchase.
