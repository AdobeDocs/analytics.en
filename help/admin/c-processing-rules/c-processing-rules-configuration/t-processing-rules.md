...
1. Add an note that contains details on the rule and then click **[!UICONTROL Save]**.
   ...
   See [Examples of Processing Rules](../../../../admin/admin/c-processing-rules/processing-rules-examples/processing-rules-examples.md) for information about the kinds of rules you can create.
