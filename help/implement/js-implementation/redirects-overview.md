...
uuid: 34940456-8f64-4848-868a-d1ab71ae4da0
index: y
internal: n
snippet: y
---
...
* [Example: Browsing Without Redirects](../js-implementation/redirects-overview.md#section_5C835A4D665A4625A23333C2C21F152D) 
* [Example: Browsing With Redirects](../js-implementation/redirects-overview.md#section_921DDD32932847848C4A901ACEF06248)
...
[Implementing Redirects](../js-implementation/redirects-overview.md#concept_5EC2EE9677A44CC5B90A38ECF28152E7) discusses how to leverage [!DNL Analytics] variables to capture the data lost in the redirect. Specifically, the section discusses how to fix the "discount airline tickets" situation described above. 
