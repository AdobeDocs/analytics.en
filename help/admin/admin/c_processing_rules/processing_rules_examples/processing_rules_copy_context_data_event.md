...
topic: Admin tools
uuid: aad80763-0367-4bb3-860f-7e49f4ebd2d7
index: y
internal: n
snippet: y
---
...
The following rule definition expands on the [Copy a Context Data Variable to an eVar](../../../admin/c_processing_rules/processing_rules_examples/processing_rules_copy_context_data.md#concept_43AA4980A2D847D6A3BEC50BCC0780E7) rule to also set an event on every hit that contains a specific context data variable: 
