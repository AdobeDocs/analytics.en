...
> [!NOTE] Without link events like [!UICONTROL Video Views] or [!UICONTROL Exit Links], time spent on the last hit of a visit cannot be known. Additionally, for similar reasons, [!UICONTROL Bounce Visits] (i.e. [!UICONTROL Visits] with a single hit) will not have a [!UICONTROL Time Spent]associated.
