...
seo-title: Conversion Variables (eVar)
solution: Analytics
title: Conversion Variables (eVar)
topic: Admin tools
uuid: 759ca616-37b1-44d5-958a-ba5cf1443b69
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Only a single value can be stored in an eVar in an image request. If multiple values are desired in an eVar value, we recommend that you implement [List variables (list vars)](https://marketing.adobe.com/resources/help/en_US/sc/implement/listN.html).

## Conversion Variables - Descriptions {#section_7C317BB0287A4B8EB0A1A4ECC40627BF}

Descriptions of fields used when [editing conversion variables](t_conversion_variables_admin.md#task_051920D9B3E24A00A28F32EEBBB0EF97). 
...
<table id="table_E48D50926E6B492183300CA58A886927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Defines the eVar status: </p> <p> <span class="uicontrol"> Disabled:</span> Disables the eVar. Removes the eVar from the conversion variable list. </p> <p> <span class="uicontrol"> No Subrelations:</span> Prevents you from breaking down the eVar with a subrelation. </p> <p> <span class="uicontrol"> Basic Subrelations: </span>Lets you break down an eVar by any report with full subrelations (for example, Products or Campaign). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Merchandising variables can follow one of two syntaxes: </p> <p> <span class="uicontrol"> Products Syntax:</span> Associates the eVar value to a product. <p>Note:  If Products Syntax is selected, the Merchandising Binding Event section is disabled and not selectable for edit. For this syntax, Binding Events are not applicable. </p> </p> <p> <span class="uicontrol"> Conversion Variable Syntax:</span> Associates the eVar with a product only if a Binding Event occurs. In this case, you select the events that act as Binding Events. </p> <p>Changing this setting without updating your JavaScript code accordingly causes lost data. See <a href="http://marketing.adobe.com/resources/help/en_US/sc/implement/?f=var_merchandising" format="http" scope="external"> Merchandising Variables</a>. </p> </td> 
  </tr> 
  <tr> 
