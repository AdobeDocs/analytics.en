...
uuid: 390e5d5a-25d5-4ca1-8025-20eadd2713a4
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>`clearVars()` is included in [AppMeasurement for JavaScript](../js-implementation/c-appmeasurement-js/appmeasure-mjs.md#concept_F3957D7093A94216BD79F35CFC1557E8) but is not available in H code and previous versions.
