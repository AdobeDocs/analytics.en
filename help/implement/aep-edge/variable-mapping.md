...
| `placeContext.localTime` | Sets the visitor's timezone information. Appears as `t_time_info` in [Data feeds](/help/export/analytics-data-feed/c-df-contents/datafeeds-reference.md). |
