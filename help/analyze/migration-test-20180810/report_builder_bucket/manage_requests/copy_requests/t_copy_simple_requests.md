...
uuid: 8cb8d96a-eaa5-419c-a196-dac9c4ec7186
index: y
internal: n
snippet: y
translate: y
...
A[ referential request](t_copy_referential_requests.md#task_82A145CC2A774F5EA86977D670E07DC8) uses values from cells as input for parameters, such as a data filter or relational filter. These filters use either matching or trending and are based on results of a prior request or on the user-entered contents of a cell, called an input cell . 
