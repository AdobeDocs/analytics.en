...
title: Plan segments
topic: Segments
uuid: b3c36c15-2a42-4f98-abb9-689561b11a74
index: y
internal: n
snippet: y
---
...
1. Determine the segment **scope**. Which [segment container](../../c-segmentation/seg-overview.md#concept_82653C7E29FE49F5A4B5E5E93B0A6399) best represents the scope? Use the smallest container possible. 

1. Decide which **elements** to include in the segment definition, and which values. Consider [variable persistence](../../c-segmentation/seg-overview.md#concept_E579D72B1C644AE9A4C4EAF6B47A4DCB) in this decision. 
