...
topic: Admin tools
uuid: 72a0b08f-e199-46c0-b258-d866b63fb497
index: y
internal: n
snippet: y
---
...
1. Set up real-time data collection for up to three reports, with one metric and three dimensions or classifications per report.
   ...
   For more information about classifications, see [About Classifications](../c_classifications2/c_classifications.md#concept_4CEC7FF1A9E24204A7DA6B9AC70709DE).
