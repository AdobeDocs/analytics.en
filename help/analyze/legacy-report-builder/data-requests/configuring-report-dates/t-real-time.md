...
1. Ensure that real-time reporting is enabled in the [Admin Tools](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/realtime/t-realtime-admin.md).
...
1. Click **[!UICONTROL Next]** and continue [configuring the request layout](/help/analyze/legacy-report-builder/layout/layout.md).
