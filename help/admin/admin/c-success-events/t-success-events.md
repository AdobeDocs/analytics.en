...
topic: Admin tools
uuid: 7510da9e-e5e6-4067-80e6-9c9beef6b149
index: y
internal: n
snippet: y
---
...
1. In the **[!UICONTROL Type]** column, select the checkbox next each item to enable the drop-down list, then select the desired type.
   ...
   >[!NOTE]
   >
   >Before you change an event type, see [Change event type](../../admin/c-success-events/event-type.md#concept_2A6FCC19E7FC429DBDFA65BC640BD448).

   See [Success Events Page - Descriptions](../../admin/c-success-events/success-event.md#section_681ECEC981694CABBDBF00E18165B447) for information about these elements. 
