...
For more information on Data Governance labels, see [Data Privacy Labels for Analytics Variables](/help/admin/admin/privacy-labeling/gdpr-labels.md).
...
For a step-by-step walkthrough to get ready for Data Privacy rules, see [Adobe Analytics Data Privacy Workflow](privacy-workflow.md).
