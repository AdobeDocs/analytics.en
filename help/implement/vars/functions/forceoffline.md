...
> [!IMPORTANT] Only use this function when `trackOffline` is `true`. Using this function outside of offline tracking can cause data loss.
...
You can call the `s.forceOffline()` method anywhere in your implementation after you instantiate the Analytics object instance.
