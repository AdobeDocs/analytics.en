...
>[!TIP]
>If you want see data based on the first hit of a visit instead of the first value seen in a visit, you can use a [segment](/help/components/segmentation/seg-overview.md). Use a hit container where [Hit depth](hit-depth.md) equals 1, then use that segment with the desired variable.
