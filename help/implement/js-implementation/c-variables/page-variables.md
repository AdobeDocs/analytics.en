...
eVars can be configured in the Admin Console. All eVars can be configured with a [!UICONTROL Name], [!UICONTROL Type], [!UICONTROL Allocation], [!UICONTROL Expire After Setting], or [!UICONTROL Reset]. Each configuration setting is addressed separately. 
