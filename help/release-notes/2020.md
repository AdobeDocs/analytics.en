...
* **CX Enterprise Audience Optimization**: This feature enables you to publish segments to the CX Enterprise within 8 hours (instead of the previous 48-hour processing time). [Learn more...](/help/components/segmentation/segmentation-workflow/seg-publish.md)
