...
2. Select any of the following product features to configure it:   
   ...
   | Report suites | Lets you define the rules that govern how data is processed in a report suite. | [Report Suite manager](/help/admin/tools/manage-rs/report-suites-admin.md)  |
   ...
   | Advertising Analytics | Configure Adobe Analytics to show all your Google Ads and Microsoft Advertising paid search data side by side. | [Configure Advertising Analytics](/help/admin/tools/manage-rs/edit-settings/advertising-analytics-config.md) |
