...
topic: Admin tools
uuid: 703c3bfd-3bab-4e54-b429-85f7dbb33e07
index: y
internal: n
snippet: y
---
...
1. Set up real-time data collection for up to three reports, with one metric and three dimensions or classifications per report.
   ...
   For more information about classifications, see [About Classifications](../c-classifications2/c-classifications.md#concept_4CEC7FF1A9E24204A7DA6B9AC70709DE).
