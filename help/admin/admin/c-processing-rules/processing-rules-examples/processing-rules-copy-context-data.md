...
For more information on implementing context data variables, see [Context data variables](../../../../implement/js-implementation/c-variables/context-data-variables.md) in the Implement user guide.
