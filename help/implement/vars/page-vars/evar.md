...
* [`xdm`](/help/implement/aep-edge/xdm-var-mapping.md): `xdm._experience.analytics.customDimensions.eVars.eVar1` to `xdm._experience.analytics.customDimensions.eVars.eVar250`
* [`data`](/help/implement/aep-edge/data-var-mapping.md): `data.__adobe.eVar1` to `data.__adobe.eVar250`; or `data.__adobe.v1` to `data.__adobe.v250`
