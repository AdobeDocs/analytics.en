...
uuid: 60986a41-acf6-4982-a5c1-aea1d3ad6c02
index: y
internal: n
snippet: y
translate: y
...
**Filter** calculated metrics by clicking on the Filter icon:  ![](Graphics/segment_filter.png) . The Advanced Filters dialog is populated with both standard and calculated metrics. 

Available filters include: 

![](Graphics/advanced_filters (2).png) 
...
![](Graphics/filtering_for_metric.png) 
