...
| **JSON Export for migrating tags implementation to Web SDK tags**  | This update to the Analytics tags Extension is related to migrating to Web SDK. You can use this update to the Adobe Analytics extension as part of your workflow to recreate your extension configurations with the Web SDK extension. In the Adobe Analytics tags extension, you can view eVars, props and events settings as JSON, which can be exported for editing and included in the Web SDK extension. (Documentation to follow) |  | October 31, 2024 |
