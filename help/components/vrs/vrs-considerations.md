...
> [!NOTE]  The following considerations apply ONLY to these cases:
>
...
> [!NOTE] While virtual report suites do not allow you to convert revenue data into another currency at a historical rate, >you can still convert currency in a virtual report suite on an ad-hoc basis. You can apply the current day's >exchange rate to historical data by going to Components > Report Settings.
