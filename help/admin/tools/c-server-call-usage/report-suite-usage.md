...
![](/help/admin/tools/c-server-call-usage/assets/report-suite-usage.png)
...
1. Click **[!UICONTROL Download Report]**.
   ...
   ![](/help/admin/tools/c-server-call-usage/assets/download_report.png)
...
![](/help/admin/tools/c-server-call-usage/assets/download-usage.png)
