...
+ Implement Analytics using JavaScript {#javascript-implementation}
  ...
  + Unique visitors {#unique-visitors}
    ...
    + [Browsers and Analytics Cookies](js-implementation/c-unique-visitors/cookie-changes.md)
  ...
  + Cross-device visitor identification {#cross-device-visitor-id}
    ...
    + [Cross-device example](js-implementation/xdevice-visid/visit-example.md)
    + [Attribution and persistence](js-implementation/xdevice-visid/variable-persistence.md)
    + [Cross-device FAQ](js-implementation/xdevice-visid/xdevice-faq.md)
