...
>Before using Reports and Analytics, understand these basic login and setup tasks, and how to access account information.For advanced users and administrators familiar with the interface, the [ Analytics Help Reference ](https://marketing.adobe.com/resources/help/en_US/reference/index.html) is available. 
