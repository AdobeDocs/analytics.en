...
Adobe computes this dimension server-side from the visitor's visit history. There is no variable to set; it works out of the box for all implementations.
