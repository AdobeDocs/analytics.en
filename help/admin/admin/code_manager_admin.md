...
title: Code Manager
topic: Admin tools
uuid: 3ccad901-0138-4827-8a0a-925d64f31b70
index: y
internal: n
snippet: y
---
...
After you download the library, you must configure the code to send data to the correct tracking server and report suite. Additional implementation resources are available at [Developer & Implementation](../data_collection/developer.md#concept_0151FC2D93434EE6BB3300D7F1A33E4A).
...
<table id="table_E48D50926E6B492183300CA58A886927"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <span class="uicontrol"> Type</span> </td> 
