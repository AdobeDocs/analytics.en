...
Demographic and interests data is not automatically collected by Adobe. However if your organization obtains this data, you can use customer attributes, a feature within the Adobe CX Enterprise Platform. It allows full control over the organizing of data by attributes, and is not limited to just demographics or interests.
