...
Pre-built reports in Analysis Workspace provide quick insights into the most common reporting scenarios. Following are some examples of questions that you can answer with prebuilt reports:
...
The following table contains the complete list of available pre-built reports.

Some of the most popular pre-built reports include, Flow, Fallout, Marketing channel, and Real-time reports. 
