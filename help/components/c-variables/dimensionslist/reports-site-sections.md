...
* This report references data directly from the [s.channel](https://docs.adobe.com/content/help/en/analytics/implementation/vars/page-vars/channel.html) variable implemented on your website.
...
* This report can utilize the following metrics:
    ...
    * **Pageviews**: the number of times the [pageName](https://docs.adobe.com/content/help/en/analytics/implementation/vars/page-vars/pagename.html) variable or URL was defined (set as the default metric) 
