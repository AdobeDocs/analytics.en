...
seo-title: Histogram
title: Histogram
uuid: 873a8163-a8c9-4810-aef5-f64acca9ef5a
index: y
internal: n
snippet: y
translate: y
...
A histogram is similar to a bar chart, but it groups numbers into ranges (buckets). Analytics automates the "bucketing" of numbers into ranges, but you can change the settings in [ Advanced Settings ](../../analysis_workspace_bucket/freeform-analysis-visualizations/histogram.md#section_09D774C584864D4CA6B5672DC2927477). 
