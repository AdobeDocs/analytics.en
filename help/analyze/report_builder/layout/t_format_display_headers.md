...
uuid: 8631866a-ce2e-48d2-9b50-97ea549207f3
index: y
internal: n
snippet: y
---
...
1. Configure the [!UICONTROL Display] options:
 ...
 <tr class="chrow strow"> 
   ...
   ** Name this Request:** Lets you type a user-defined name for the request, or use the default name selected on Step 1. This name appears as the [!UICONTROL Report] name in the [!UICONTROL Request Manager]. See [Name a Request](../../report_builder/layout/name_a_request.md#concept_37277AFB63EA4541B6FD93A5B713D82D). 
