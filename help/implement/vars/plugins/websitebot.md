...
1. Add a Direct Call Rule that fires an Analytics beacon using `websiteBot` as the identifier. In this example it uses a `s.tl` call:

   ![websiteBot identifier](assets/websitebot.png)

1. Fire the Adobe Analytics – Set Variables & Adobe Analytics – Send Beacon actions in the Direct Call rule.  One way to do this is shown in the following example:

   ![Send Beacon actions](assets/websitebot2.png)
