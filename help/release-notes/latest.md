...
| ----------- | ---------- | ------- | ---- |
| | **Select multiple filters when they are available in the drop-down menu in a freeform table** |  
When multiple filters have been added to a freeform table as a drop-down menu, users of the freeform table can now select more than one filter at a time. The freeform table is filtered to include any of the selected filters. Previously, users could select only one filter at a time in a filter drop-down menu.<p>For more information, see "Add filters to a project" in "Use components in Analysis Workspace." |  | June 12, 2024 |
| **Table of contents for Workspace projects** | A new table of contents is now available for projects. The table of contents provides links that enable users to quickly jump to panels and visualizations within the project. The table of contents can be enabled for individual projects or for all projects for a given user.<p>For more information, see "Display the project table of contents" in "Create projects". |  | June 12, 2024 |
| **Add hyperlinks to dimension items in a freeform table** |<ul><li>Add hyperlinks to dimension items to make them clickable within a freeform table in Analysis Workspace.</li><li>Add hyperlinks to one or more dimension items in a freeform table.</li><li>Add hyperlinks to dimension items that have URL values or you can create custom URLs for dimension items that have non-URL values.</li><li>Create dynamic custom URLs for multiple dimension items by using variables. Variables can reference the value of each dimension item or they can reference the breakdown dimension.</li></ul>For more information, see "Add hyperlinks to dimensions in a freeform table." |  | June 12, 2024 |
...
| --- | --- | --- |
| **EOL of Adobe Analytics 1.4 API** | June 12, 2024 | In 2026, the Adobe Analytics 1.4 API will be deprecated. Customers will need to upgrade to 2.0 APIs over the next 2 years  - link to public announcement. |
