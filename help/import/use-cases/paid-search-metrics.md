...
1. Now "map" this new data source to the custom events we created in [Success events](/help/admin/tools/c-manage-report-suites/c-edit-report-suites/conversion-var-admin/c-success-events/success-event.md).
