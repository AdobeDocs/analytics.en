...
| **June 2020** | |
| June 25, 2020 | Quick Insights panel in Workspace provides guidance for non-analysts and new users of Analysis Workspace to learn how to answer business questions quickly and easily. [Learn more...](/help/analyze/analysis-workspace/c-panels/quickinsight.md)|
| June 25, 2020 | Analytics for Target panel in Workspace lets you analyze your Adobe Target activities and experiences, with lift and confidence. [Learn more...](/help/analyze/analysis-workspace/c-panels/a4t-panel.md)|
...
| May 21, 2020 |  Documentation on accessibility improvements to Analysis Workspace, including improved keyboard navigation, color contrast, and screen reader support. [Learn more...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/aw-accessibility.html) |
| **April 2020** |  |
...
| February 12, 2020 | Added new hotkeys to [this Workspace page](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.html?lang=en) |
...
| October 25, 2019 | Updated [Adobe Analytics Key Concepts](https://experienceleague.adobe.com/docs/analytics/landing/an-key-concepts.html?lang=en) page. |
...
| September 19, 2019 | Revised segmentation documentation to explain [Logic Group containers](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-sequential-build.html?lang=en#logic-group-containers). |
| September 12, 2019 | New documentation for [Journey IQ: Cross-Device Analytics](/help/components/cda/overview.md) |
| September 12, 2019 | Update [Calculated metrics totals](https://experienceleague.adobe.com/docs/analytics/components/calculated-metrics/calcmetrics-reference/cm-totals.html?lang=en) document. |
