...
title: Build Metrics
uuid: f65e72cc-7a3a-407e-b0cf-dbe94f14acfd
index: y
internal: n
snippet: y
translate: y
...
* Click ** [!UICONTROL  + Add] ** at the top of the [ Calculated Metric Manager ](cm_manager.md#concept_BA6815CB06D842D5825766396B691653), or
* Go to ** [!UICONTROL  Analytics] ** > ** [!UICONTROL  Reports] **, open any report and click the Metrics icon  ![](graphics/metrics_icon.png) to bring up the Metrics rail, then click ** [!UICONTROL  Add] **.
![](graphics/cm_builder_ui.png) 
...
<table id="table_60A82936321047D1A335331BF83B0972"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Divided by ( <img placement="inline" href="graphics/divided_icon.png" id="image_320D7363DE024BDEB21E44606C8B367F" width="25px" /> ) is the default operator, plus there are the +, -, and x operators. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Gear icon ( <span class="uicontrol"> Metric Type </span>, <span class="uicontrol"> Metric Allocation </span>) </td> 
   <td colname="col3"> <p>Selecting the gear icon next to a metric lets you specify the <a href="m_metric_type_alloc.xml#concept_B7A1FCFEFA9D4C4883208ACE8C9C8E5E" format="dita" scope="local"> metric type and the metric allocation </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Metrics come in 3 categories: </p> 
    <ul id="ul_7BF50F4964EF45858FBA1634FBFA45CF"> 
     <li id="li_90F2312927A6499CA1CE04F8FFC912CF">Standard metrics ( <img placement="inline" href="graphics/met_icon.png" id="image_65A80F54D73443E78542FE0B31CC3F20" />) </li> 
     <li id="li_A3F59083E79B4AC780D6F8CEDFFD20C9">Calculated metrics ( <img placement="inline" href="graphics/calc_met_icon.png" id="image_C5674AB9B9EB4DA9A56782D15822C319" />) </li> 
     <li id="li_8735E76637ED4C3F983731A66E04C93E">Metrics templates ( <img placement="inline" href="graphics/cm_template_icon.png" width="25px" id="image_D236601511CC4DD3828F223431E27E88" />) - at the bottom of the list. </li> 
    </ul> <p>When you hover over a metric, you can see the Info icon to the right of it: <img placement="inline" href="graphics/info.png" width="150px" id="image_5A65E772A68A4B94ACAD6552CCF21F5F" />. Clicking this icon gives you the following information: </p> 
    ...
    </ul> <p style="text-align: center;"> <img placement="break" align="center" href="graphics/info2.png" width="200px" id="image_7D5B2F026A034118BE4DA81B9215A883" /> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>(Advanced calculated metrics only) Functions are divided into two lists: <a href="cm_functions.xml#concept_E3022D5EEEE145B69A23438BAF7016B2" format="dita" scope="local"> Basic </a> (used most often) and <a href="cm_adv_functions.xml#concept_A5FB9127D70F4E1AA02D1ACBF4F54174" format="dita" scope="local"> Advanced </a>. </p> </td> 
  </tr> 
  <tr> 
