...
>[!NOTE]
>
>The following information is related to FTP and SFTP destination types. FTP and SFTP are legacy destination types. When configuring a data warehouse report, you should use a cloud destination type, which are more secure. For more information about configuring cloud destination types for a Data Warehouse report, see [Create a Data Warehouse request](/help/export/data-warehouse/create-request/t-dw-create-request.md).
