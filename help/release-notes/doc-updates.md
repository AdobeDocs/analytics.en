...
| **November 2023** | |
| Updates to Activity Map activation/enablement topic | Added [Web SDK](https://experienceleague.adobe.com/docs/analytics/analyze/activity-map/getting-started/activitymap-enable.html) (both manual and via Adobe Experience Platform tags extension) content. |
| **October 2023** | |
