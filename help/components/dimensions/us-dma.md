...
Adobe derives this dimension server-side from the visitor's IP address, matching it against an internal lookup table. Adobe partners with Nielsen to maintain lookups between IP address and DMA. There is no variable to set.
