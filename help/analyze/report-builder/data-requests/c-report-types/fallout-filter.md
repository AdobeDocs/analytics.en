...
uuid: 8e4f4eb8-f13a-492e-83c9-7305ed19fc93
index: y
internal: n
snippet: y
---
...
1. Configure the appropriate [date ranges](../../../report-builder/data-requests/configuring-report-dates/configuring-report-dates.md#concept_4419F6B0BC274DC7A07086DA56703DFE).
...
1. If you select from a list, click **[!UICONTROL Add]** to select checkpoints to add to the fallout path. You can define between 3 and 8 checkpoints. (Search for available elements by clicking **[!UICONTROL More]**.)
   ...
   For more information on refining the filter, see [Filter Dimensions](../../../report-builder/layout/c-filter-dimensions/filter-dimensions.md#concept_9C0518E2CF604AADA97DDBB1B4ECAAF8). 1. Move **[!UICONTROL Available Elements]** from the left column to the right by selecting them and clicking the orange arrow.
