...
uuid: 19c90d29-d825-4ccd-8e00-26133dd5203f
index: y
internal: n
snippet: y
translate: y
...
1. In the Calculated Metric Manager, mark the checkbox next to the metric you want to share. The task bar appears: ![](graphics/cm_task_bar.png) 

1. Click the ** [!UICONTROL  Share] ** icon. ![](graphics/cm_share.png) 
...
1. Click ** [!UICONTROL  Share] **. The Shared icon appears next to the metric:  ![](graphics/share_icon.png) 
