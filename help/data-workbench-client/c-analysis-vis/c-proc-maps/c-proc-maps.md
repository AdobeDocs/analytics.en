...
uuid: 2c00dd7c-8d2d-4a8e-8e3d-4603fcc208f7
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>For these maps to work most effectively, you should open a color legend in the workspace. For information about using color legends with process maps, see [Activating Color Links](../../../data-workbench-client/c-analysis-vis/c-proc-maps/c-act-color-lnks.md#concept_2C9B9F67F2BD4CD7A5431FA21C094EDC). For more information about color legends, see [Color Legends](../../../data-workbench-client/c-analysis-vis/c-legends/c-color-leg.md#concept_F84D51DC0D6547F981D0642FC2D01358).
...
>[!NOTE]
>
>You can change the default dimensions or metric for a process map. For steps to configure a process map, see [Configuring Process Maps](../../../data-workbench-client/c-intf-anlys-ftrs/t-config-proc-maps.md#task_4A95730B18A14BC790A77C013832B2D6).
