...
uuid: 5c1f4a5c-cc62-4b14-a963-e364cc0acff6
index: y
internal: n
snippet: y
---
...
* When to use a [custom event](../analytics-terminology-basics/c--props-evars/event-custom.md#concept_CDA3C98C85B24A71B4B5C71F24BF918F)
...
For more information, see [Implementing Analytics with Dynamic Tag Management](../c-implement-with-dtm/c-implement-with-dtm.md#concept_90C125C03E024A9A9A1D7F47B3CCF4B5).
...
For more information, see [Implementing Analytics Using JavaScript](../js-implementation/js-implementation.md#concept_CE78750AC2A4487D8ACD9369B3EAC85A). 
